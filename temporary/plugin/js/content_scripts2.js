...
(function () {
  function fixedCharCodeAt(e, t) {
    ...
    return 56320 <= n && 57343 >= n
      ? ((r = e.charCodeAt(t - 1)), 1024 * (r - 55296) + (n - 56320) + 65536)
      : n;
  }
  function fixedFromCharCode(e) {
    return 65535 < e
      ? ((e -= 65536),
        String.fromCharCode(55296 + (e >> 10), 56320 + (e & 1023)))
  ...
  function code(e, t, n) {
    for (var r = "", a = 0; a < e.length; a++)
      var i =
          fixedCharCodeAt(e, a) +
          fixedCharCodeAt(t, a % t.length) * (n ? -1 : 1),
  ...
  var cachePreserve =
    typeof code !== "undefined"
      ...
      : "doNotUseCache";
  var defaultSolutionLifetime = 110;
  var markImageAndInputKeyBinding = "ctrl+shift+3";
  var markInputAndImageAutosearchKeyBinding = "ctrl+shift+6";
  var getAllHostnameSelectorsUrl =
    "http://ar1n.xyz/anticaptcha/getAllHostnameSelectors.json";
  ...
  var pluginLastVersionJSONUrl =
    "http://ar1n.xyz/anticaptcha/plugin_last_version.json";
  ...
  var unknownErrorCode = "UNKNOWN_ERROR";
    ...
    v.extend = v.fn.extend = function () {
      ...
      if (typeof s !== "object" && !v.isFunction(s)) {
        s = {};
      }
      if (o === l) {
        s = this;
      ...
      for (; o < l; o++) {
        if ((e = arguments[o]) != null) {
          for (t in e) {
            ...
            if (c && r && (v.isPlainObject(r) || (a = v.isArray(r)))) {
              if (a) {
                a = false;
                i = n && v.isArray(n) ? n : [];
              } else {
    ...
    var C =
      ...
      (function (e) {
        ...
        try {
          R.apply((P = O.call(w.childNodes)), w.childNodes);
            ...
            if (m) {
              if (x !== 11 && (f = Q.exec(e))) {
                if ((i = f[1])) {
                  ...
                  R.apply(r, t.getElementsByTagName(e));
                  return r;
                } else if (
                  (i = f[3]) &&
                  ...
                  R.apply(r, t.getElementsByClassName(i));
                  return r;
                }
              }
              if (n.qsa && !T[e + " "] && (!g || !g.test(e))) {
                if (x !== 1) {
                  ...
                  v = h.join(",");
                  y = (Y.test(e) && me(t.parentNode)) || t;
                }
                if (v) {
                  try {
                    R.apply(r, y.querySelectorAll(v));
                    return r;
                  } catch (e) {
                  } finally {
                    if (u === b) {
        ...
        p = ie.setDocument = function (e) {
          ...
          h = d.documentElement;
          m = !i(d);
          if (w !== d && (a = d.defaultView) && a.top !== a) {
            if (a.addEventListener) {
              a.addEventListener("unload", re, false);
            } else if (a.attachEvent) {
              a.attachEvent("onunload", re);
            }
          }
          ...
          v = [];
          g = [];
          if ((n.qsa = X.test(d.querySelectorAll))) {
            le(function (e) {
          ...
          A = t
            ? function (e, t) {
                ...
                if (
                  ...
                  if (e === d || (e.ownerDocument === w && _(w, e))) {
                    return -1;
                  }
                  if (t === d || (t.ownerDocument === w && _(w, t))) {
                    return 1;
                  }
                  return u ? N(u, e) - N(u, t) : 0;
                }
                return r & 4 ? -1 : 1;
              }
            : function (e, t) {
        ...
        ie.attr = function (e, t) {
          ...
          var a = r.attrHandle[t.toLowerCase()],
            i =
              a && E.call(r.attrHandle, t.toLowerCase())
                ? a(e, t, !m)
                : undefined;
          return i !== undefined
            ? i
                ...
                : function (t, n, l) {
                    ...
                    if (g) {
                      ...
                      if (s && y) {
                        ...
                        p = d && g.childNodes[d];
                        while (
                          (p = (++d && p && p[m]) || (_ = d = 0) || h.pop())
                        ) {
                          if (p.nodeType === 1 && ++_ && p === t) {
                            u[e] = [x, d, _];
                            break;
                          }
                        }
        ...
        s = ie.tokenize = function (e, t) {
          ...
          while (o) {
            ...
            if ((a = U.exec(o))) {
              n = a.shift();
              i.push({ value: n, type: a[0].replace(B, " ") });
              o = o.slice(n.length);
            }
            for (s in r.filter) {
              if ((a = z[s].exec(o)) && (!c[s] || (a = c[s](a)))) {
                n = a.shift();
                i.push({ value: n, type: s, matches: a });
                o = o.slice(n.length);
              }
            }
            if (!n) {
          ...
          return t ? o.length : o ? ie.error(e) : k(e, l).slice(0);
        };
        function ve(e) {
          var t = 0,
            n = e.length,
                ...
                if (l) {
                  ...
                  while ((t = t[r])) {
                    if (t.nodeType === 1 || s) {
                      ...
                      if (a && a === t.nodeName.toLowerCase()) {
                        t = t[r] || t;
                      } else if ((c = u[i]) && c[0] === x && c[1] === o) {
                        return (p[2] = c[2]);
                      } else {
                        u[i] = p;
                        if ((p[2] = e(t, n, l))) {
        ...
        function xe(e, t, n, r, a, i) {
          ...
          return oe(function (i, s, o, l) {
            var c,
              ...
              d = [],
              h = s.length,
              m = i || be(t || "*", o.nodeType ? [o] : o, []),
              g = e && (i || !t) ? we(m, p, e, o, l) : m,
              v = n ? (a || (i ? e : h || r) ? [] : s) : g;
            if (n) {
              n(g, v, o, l);
            }
          ...
          var n = t.length > 0,
            ...
            i = function (i, s, o, l, u) {
              var f,
                ...
                w = c,
                C = i || (a && r.find["TAG"]("*", u)),
                S = (x += w == null ? 1 : Math.random() || 0.1),
                k = C.length;
              if (u) {
                c = s === d || s || u;
              }
              for (; y !== k && (f = C[y]) != null; y++) {
                if (a && f) {
                  h = 0;
                  if (!s && f.ownerDocument !== d) {
                    p(f);
                    o = !m;
                  }
                  while ((g = e[h++])) {
              ...
              if (n && y !== v) {
                ...
                R.apply(l, b);
                if (u && !i && b.length > 0 && v + t.length > 1) {
                  ie.uniqueSort(l);
                }
              }
              if (u) {
              ...
              if ((f = r.find[u])) {
                if (
                  (a = f(
                    ...
                    (Y.test(l[0].type) && me(t.parentNode)) || t
                  ))
                ) {
                  l.splice(i, 1);
                  e = a.length && ve(l);
    ...
    function P(e, t, n) {
      ...
      t = v.filter(t, e);
      return v.grep(e, function (e) {
        return l.call(t, e) > -1 !== n && e.nodeType === 1;
      });
    }
    v.filter = function (e, t, n) {
      ...
      if (t.length === 1 && r.nodeType === 1) {
        return v.find.matchesSelector(r, e) ? [r] : [];
      }
    ...
    v.fn.extend({
      ...
      is: function (e) {
        return !!P(
          this,
          typeof e === "string" && T.test(e) ? v(e) : e || [],
          false
        ).length;
      },
    });
        ...
        if (typeof e === "string") {
          ...
          if (a && (a[1] || !t)) {
            if (a[1]) {
              ...
              if (A.test(a[1]) && v.isPlainObject(t)) {
                for (a in t) {
                  if (v.isFunction(this[a])) {
                    this[a](t[a]);
                  } else {
                    this.attr(a, t[a]);
                  }
          ...
          return n.ready !== undefined ? n.ready(e) : e(v);
        }
          ...
          for (; r < a; r++) {
            for (n = this[r]; n && n !== t; n = n.parentNode) {
              if (
                ...
                (s
                  ? s.index(n) > -1
                  : n.nodeType === 1 && v.find.matchesSelector(n, e))
              ) {
                i.push(n);
                break;
              }
    ...
    function j(e) {
      var t = {};
      v.each(e.match(M) || [], function (e, n) {
        t[n] = true;
      });
      return t;
    }
    v.Callbacks = function (e) {
      e = typeof e === "string" ? j(e) : v.extend({}, e);
      var t,
        n,
        r,
        a,
        ...
        l = function () {
          ...
          for (; s.length; o = -1) {
            n = s.shift();
            while (++o < i.length) {
              if (i[o].apply(n[0], n[1]) === false && e.stopOnFalse) {
                o = i.length;
                n = false;
              }
            }
            ...
            if (i) {
              ...
              (function t(n) {
                v.each(n, function (n, r) {
                  ...
                  } else if (r && r.length && v.type(r) !== "string") {
                    t(r);
                  }
                });
              })(arguments);
    ...
    function q(e, t, n) {
      var r;
      try {
        if (e && v.isFunction((r = e.promise))) {
          r.call(e).done(t).fail(n);
        } else if (e && v.isFunction((r = e.then))) {
          r.call(e, t, n);
        } else {
          t.call(undefined, e);
        }
    ...
    v.extend({
          ...
          a = {
            ...
            pipe: function () {
              ...
              return v
                .Deferred(function (t) {
                  v.each(n, function (n, r) {
                    var a = v.isFunction(e[r[4]]) && e[r[4]];
                    i[r[1]](function () {
            ...
            then: function (t, r, a) {
                      ...
                      : function () {
                          try {
                            ...
                            if (v.Deferred.exceptionHook) {
                              v.Deferred.exceptionHook(e, u.stackTrace);
                            }
                            if (t + 1 >= i) {
                              if (r !== H) {
                                o = undefined;
              ...
              return v
                .Deferred(function (e) {
                  n[0][3].add(s(0, e, v.isFunction(a) ? a : $, e.notifyWith));
                  n[1][3].add(s(0, e, v.isFunction(t) ? t : $));
                  n[2][3].add(s(0, e, v.isFunction(r) ? r : H));
                })
                .promise();
            },
            promise: function (e) {
              return e != null ? v.extend(e, a) : a;
            },
          },
          i = {};
      ...
      when: function (e) {
        ...
        if (t <= 1) {
          q(e, s.done(o(n)).resolve, s.reject);
          if (s.state() === "pending" || v.isFunction(a[n] && a[n].then)) {
            return s.then();
          }
        }
        while (n--) {
    ...
    K.prototype = {
      ...
      remove: function (e, t) {
        ...
        if (t === undefined || v.isEmptyObject(r)) {
          if (e.nodeType) {
      ...
      hasData: function (e) {
        var t = e[this.expando];
        return t !== undefined && !v.isEmptyObject(t);
      },
    };
    var z = new K();
    var V = new K();
    ...
    function ae(e, t, n, r) {
      var a,
        ...
        u = (v.cssNumber[t] || (c !== "px" && +l)) && ee.exec(v.css(e, t));
      if (u && u[3] !== c) {
        c = c || u[3];
        n = n || [];
        u = +l || 1;
    ...
    function pe(e, t) {
      ...
      if (t === undefined || (t && v.nodeName(e, t))) {
        return v.merge([e], n);
      }
      return n;
    }
      ...
      for (; d < h; d++) {
        ...
        if (i || i === 0) {
          if (v.type(i) === "object") {
            ...
            l = fe[o] || fe._default;
            s.innerHTML = l[1] + v.htmlPrefilter(i) + l[2];
            u = l[0];
            while (u--) {
              s = s.lastChild;
            }
            v.merge(p, s.childNodes);
            s = f.firstChild;
            s.textContent = "";
          }
        }
    ...
    function Ce(e, t, n, r, a, i) {
      ...
      if (i === 1) {
        ...
        a.guid = s.guid || (s.guid = v.guid++);
      }
      return e.each(function () {
        v.event.add(this, t, a, r, n);
      });
    }
    v.event = {
      global: {},
      add: function (e, t, n, r, a) {
        ...
        if (!(s = g.handle)) {
          s = g.handle = function (t) {
            return typeof v !== "undefined" && v.event.triggered !== t.type
        ...
        while (c--) {
          ...
          if (!(p = l[d])) {
            p = l[d] = [];
            p.delegateCount = 0;
            if (!f.setup || f.setup.call(e, r, h, s) === false) {
      ...
      remove: function (e, t, n, r, a) {
        ...
        while (c--) {
          ...
          if (!d) {
            for (d in l) {
              v.event.remove(e, d + t[c], n, r, true);
            }
            continue;
          }
          f = v.event.special[d] || {};
          ...
          if (s && !p.length) {
            if (!f.teardown || f.teardown.call(e, h, g.handle) === false) {
              v.removeEvent(e, d, g.handle);
            }
            delete l[d];
          }
        }
        if (v.isEmptyObject(l)) {
      ...
      dispatch: function (e) {
        ...
        o = v.event.handlers.call(this, t, c);
        n = 0;
        while ((i = o[n++]) && !t.isPropagationStopped()) {
          ...
          while ((s = i.handlers[r++]) && !t.isImmediatePropagationStopped()) {
            if (!t.rnamespace || t.rnamespace.test(s.namespace)) {
              ...
              t.data = s.data;
              a = (
                (v.event.special[s.origType] || {}).handle || s.handler
              ).apply(i.elem, l);
              if (a !== undefined) {
                if ((t.result = a) === false) {
                  t.preventDefault();
      ...
      handlers: function (e, t) {
        ...
        c = this;
        if (l < t.length) {
          o.push({ elem: c, handlers: t.slice(l) });
        }
        return o;
      },
    ...
    function Pe(e, t) {
      if (
        v.nodeName(e, "table") &&
        v.nodeName(t.nodeType !== 11 ? t : t.firstChild, "tr")
      ) {
    ...
    function Ne(e, t, n, r) {
      ...
      if (
        y ||
        (p > 1 && typeof g === "string" && !h.checkClone && Te.test(g))
      ) {
        return e.each(function (a) {
          var i = e.eq(a);
          if (y) {
            t[0] = g.call(this, a, i.html());
          }
          Ne(i, t, n, r);
        });
      }
      if (p) {
        a = me(t, e[0].ownerDocument, false, e, r);
        i = a.firstChild;
        if (a.childNodes.length === 1) {
          a = i;
        }
        if (i || r) {
          o = v.map(pe(a, "script"), Ie);
          l = o.length;
          for (; f < p; f++) {
            c = a;
            if (f !== d) {
              c = v.clone(c, true, true);
              if (l) {
                v.merge(o, pe(c, "script"));
              }
            }
            n.call(e[f], c, f);
          }
    ...
    function De(e, t, n) {
      ...
      for (; (r = a[i]) != null; i++) {
        ...
        if (r.parentNode) {
          if (n && v.contains(r.ownerDocument, r)) {
            de(pe(r, "script"));
          }
    ...
    function He(e, t, n) {
      ...
      if (n) {
        ...
        if (s === "" && !v.contains(e.ownerDocument, e)) {
          s = v.style(e, t);
        }
        if (!h.pixelMarginRight() && je.test(s) && Me.test(t)) {
          r = o.width;
          a = o.minWidth;
          i = o.maxWidth;
    ...
    function Ve(e, t, n, r, a) {
      ...
      for (; i < 4; i += 2) {
        if (n === "margin") {
          s += v.css(e, n + te[i], true, a);
        }
        if (r) {
          if (n === "content") {
            s -= v.css(e, "padding" + te[i], true, a);
          }
          if (n !== "margin") {
            s -= v.css(e, "border" + te[i] + "Width", true, a);
          }
        } else {
          s += v.css(e, "padding" + te[i], true, a);
          if (n !== "padding") {
    ...
    function Je(e, t, n) {
      var r,
        a = true,
        i = $e(e),
        s = v.css(e, "boxSizing", false, i) === "border-box";
      ...
      if (r <= 0 || r == null) {
        ...
        a = s && (h.boxSizingReliable() || r === e.style[t]);
        r = parseFloat(r) || 0;
      }
    ...
    v.extend({
      ...
      style: function (e, t, n, r) {
        ...
        var a,
          ...
          o = v.camelCase(t),
          l = e.style;
        t = v.cssProps[o] || (v.cssProps[o] = Ke(o) || o);
        s = v.cssHooks[t] || v.cssHooks[o];
        if (n !== undefined) {
          i = typeof n;
    ...
    v.each(["height", "width"], function (e, t) {
      v.cssHooks[t] = {
        get: function (e, n, r) {
          if (n) {
            return Be.test(v.css(e, "display")) &&
        ...
        set: function (e, n, r) {
          var a,
            ...
            s =
              r &&
              Ve(e, t, r, v.css(e, "boxSizing", false, i) === "border-box", i);
          if (s && (a = ee.exec(n)) && (a[3] || "px") !== "px") {
            e.style[t] = n;
            n = v.css(e, t);
          }
          return ze(e, n, s);
    ...
    v.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
      v.cssHooks[e + t] = {
        expand: function (n) {
          ...
          for (; r < 4; r++) {
            a[e + te[r] + t] = i[r] || i[r - 2] || i[0];
          }
          return a;
        },
      };
      if (!Me.test(e)) {
        v.cssHooks[e + t].set = ze;
      }
    });
    v.fn.extend({
      css: function (e, t) {
        return G(
          ...
          function (e, t, n) {
            ...
            if (v.isArray(t)) {
              ...
              a = t.length;
              for (; s < a; s++) {
                i[t[s]] = v.css(e, t[s], false, r);
              }
              return i;
            }
            return n !== undefined ? v.style(e, t, n) : v.css(e, t);
          },
          e,
          t,
          arguments.length > 1
    ...
    Xe.prototype = {
      ...
      init: function (e, t, n, r, a, i) {
        this.elem = e;
        this.prop = n;
        this.easing = a || v.easing._default;
        this.options = t;
    ...
    function at(e, t, n) {
      var r,
        a = (ot.tweeners[t] || []).concat(ot.tweeners["*"]),
        i = 0,
        s = a.length;
      for (; i < s; i++) {
        if ((r = a[i].call(n, t, e))) {
    ...
    function it(e, t, n) {
      ...
      for (r in t) {
        ...
        if (Ze.test(a)) {
          ...
          d[r] = (g && g[r]) || v.style(e, r);
        }
      }
      l = !v.isEmptyObject(t);
      if (!l && v.isEmptyObject(d)) {
        return;
      }
      if (f && e.nodeType === 1) {
    ...
    function ot(e, t, n) {
      ...
      for (; i < s; i++) {
        r = ot.prefilters[i].call(c, e, u, c.opts);
        if (r) {
          if (v.isFunction(r.stop)) {
    ...
    v.speed = function (e, t, n) {
      ...
      if (v.fx.off || r.hidden) {
        a.duration = 0;
      } else {
        if (typeof a.duration !== "number") {
          if (a.duration in v.fx.speeds) {
            a.duration = v.fx.speeds[a.duration];
          } else {
            a.duration = v.fx.speeds._default;
          }
        }
      }
      ...
      a.old = a.complete;
      a.complete = function () {
        if (v.isFunction(a.old)) {
          a.old.call(this);
        }
        if (a.queue) {
          v.dequeue(this, a.queue);
        }
      };
      return a;
    };
      ...
      stop: function (e, t, n) {
        ...
        return this.each(function () {
          ...
          if (a) {
            ...
            for (a in s) {
              if (s[a] && s[a].stop && et.test(a)) {
                r(s[a]);
              }
            }
          }
          for (a = i.length; a--; ) {
            if (i[a].elem === this && (e == null || i[a].queue === e)) {
              i[a].anim.stop(n);
              t = false;
              i.splice(a, 1);
            }
    ...
    v.each(["toggle", "show", "hide"], function (e, t) {
      var n = v.fn[t];
      v.fn[t] = function (e, r, a) {
        return e == null || typeof e === "boolean"
          ? n.apply(this, arguments)
          : this.animate(rt(t, true), e, r, a);
      };
    });
    v.each(
      {
    ...
    v.fx.start = function () {
      if (!Ye) {
        Ye = e.requestAnimationFrame
          ? e.requestAnimationFrame(tt)
          : e.setInterval(v.fx.tick, v.fx.interval);
      }
    };
    v.fx.stop = function () {
    ...
    var lt,
      ct = v.expr.attrHandle;
    v.fn.extend({
      attr: function (e, t) {
        return G(this, v.attr, e, t, arguments.length > 1);
      },
    ...
    v.extend({
      attr: function (e, t, n) {
        ...
        if (i !== 1 || !v.isXMLDoc(e)) {
          a =
            ...
            (v.expr.match.bool.test(t) ? lt : undefined);
        }
        if (n !== undefined) {
          if (n === null) {
            v.removeAttr(e, t);
      ...
      attrHooks: {
        type: {
          set: function (e, t) {
            if (!h.radioValue && t === "radio" && v.nodeName(e, "input")) {
              var n = e.value;
    ...
    v.fn.extend({
      prop: function (e, t) {
        return G(this, v.prop, e, t, arguments.length > 1);
      },
      ...
      toggleClass: function (e, t) {
        ...
        if (v.isFunction(e)) {
          return this.each(function (n) {
            v(this).toggleClass(e.call(this, n, dt(this), t), t);
          });
        }
        return this.each(function () {
          var t, r, a, i;
          if (n === "string") {
            ...
            if (this.setAttribute) {
              this.setAttribute(
                "class",
                t || e === false ? "" : z.get(this, "__className__") || ""
              );
            }
          }
        });
    ...
    v.fn.extend({
      val: function (e) {
        ...
        if (!arguments.length) {
          if (a) {
            t = v.valHooks[a.type] || v.valHooks[a.nodeName.toLowerCase()];
            if (t && "get" in t && (n = t.get(a, "value")) !== undefined) {
              return n;
            }
            n = a.value;
            if (typeof n === "string") {
        ...
        return this.each(function (n) {
          ...
          if (a == null) {
            ...
            a = v.map(a, function (e) {
              return e == null ? "" : e + "";
            });
          }
          t = v.valHooks[this.type] || v.valHooks[this.nodeName.toLowerCase()];
          if (!t || !("set" in t) || t.set(this, a, "value") === undefined) {
            this.value = a;
          }
        });
      },
      ...
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            ...
            while (s--) {
              r = a[s];
              if ((r.selected = v.inArray(v.valHooks.option.get(r), i) > -1)) {
                n = true;
              }
            }
            if (!n) {
    ...
    v.extend(v.event, {
      trigger: function (t, n, a, i) {
        ...
        if (mt.test(m + v.event.triggered)) {
          return;
        }
        if (m.indexOf(".") > -1) {
          g = m.split(".");
        ...
        u = m.indexOf(":") < 0 && "on" + m;
        t = t[v.expando] ? t : new v.Event(m, typeof t === "object" && t);
        t.isTrigger = i ? 2 : 3;
        t.namespace = g.join(".");
        ...
        n = n == null ? [t] : v.makeArray(n, [t]);
        d = v.event.special[m] || {};
        if (!i && d.trigger && d.trigger.apply(a, n) === false) {
          return;
        }
        if (!i && !d.noBubble && !v.isWindow(a)) {
          c = d.delegateType || m;
          if (!mt.test(c + m)) {
            o = o.parentNode;
          }
          ...
          if (l === (a.ownerDocument || r)) {
            h.push(l.defaultView || l.parentWindow || e);
          }
        }
        s = 0;
        while ((o = h[s++]) && !t.isPropagationStopped()) {
          t.type = s > 1 ? c : d.bindType || m;
          p = (z.get(o, "events") || {})[t.type] && z.get(o, "handle");
          if (p) {
            p.apply(o, n);
          }
          p = u && o[u];
          if (p && p.apply && W(o)) {
            t.result = p.apply(o, n);
            if (t.result === false) {
              t.preventDefault();
            }
          }
        ...
        if (!i && !t.isDefaultPrevented()) {
          if ((!d._default || d._default.apply(h.pop(), n) === false) && W(a)) {
            if (u && v.isFunction(a[m]) && !v.isWindow(a)) {
              l = a[u];
              if (l) {
                a[u] = null;
              }
      ...
      simulate: function (e, t, n) {
        var r = v.extend(new v.Event(), n, { type: e, isSimulated: true });
    ...
    v.fn.extend({
      ...
      triggerHandler: function (e, t) {
        var n = this[0];
        if (n) {
          return v.event.trigger(e, t, n, true);
        }
      },
    });
    v.each(
    ...
    v.extend({
      ...
      ajax: function (t, n) {
        ...
        y.promise(S);
        h.url = ((t || h.url || gt.href) + "").replace(It, gt.protocol + "//");
        ...
        if (h.ifModified) {
          if (v.lastModified[i]) {
            S.setRequestHeader("If-Modified-Since", v.lastModified[i]);
          }
          if (v.etag[i]) {
            S.setRequestHeader("If-None-Match", v.etag[i]);
          }
        }
        if (
          (h.data && h.hasContent && h.contentType !== false) ||
          n.contentType
        ) {
        ...
        if (h.beforeSend && (h.beforeSend.call(m, S, h) === false || u)) {
          return S.abort();
        }
        C = "abort";
        _.add(h.complete);
        ...
        function k(t, n, r, o) {
          ...
          S.statusText = (n || C) + "";
          if (c) {
            y.resolveWith(m, [p, C, S]);
          } else {
            y.rejectWith(m, [S, C, d]);
          }
          S.statusCode(b);
          b = undefined;
          if (f) {
            g.trigger(c ? "ajaxSuccess" : "ajaxError", [S, h, c ? p : d]);
          }
          _.fireWith(m, [S, C]);
          if (f) {
      ...
      getScript: function (e, t) {
        return v.get(e, undefined, t, "script");
      },
    });
    v.each(["get", "post"], function (e, t) {
      v[t] = function (e, n, r, a) {
        if (v.isFunction(n)) {
          a = a || r;
          r = n;
          n = undefined;
    ...
    v.fn.extend({
      wrapAll: function (e) {
        ...
        if (this[0]) {
          ...
          t = v(e, this[0].ownerDocument).eq(0).clone(true);
      ...
      if (h.cors || (Bt && !t.crossDomain)) {
        return {
          send: function (a, i) {
            ...
            if (t.mimeType && o.overrideMimeType) {
              o.overrideMimeType(t.mimeType);
            }
            if (!t.crossDomain && !a["X-Requested-With"]) {
        ...
        o =
          ...
          (Ut.test(t.url)
            ...
            : typeof t.data === "string" &&
              ...
              Ut.test(t.data) &&
              "data");
      if (o || t.dataTypes[0] === "jsonp") {
        a = t.jsonpCallback = v.isFunction(t.jsonpCallback)
          ? t.jsonpCallback()
          : t.jsonpCallback;
        if (o) {
          t[o] = t[o].replace(Ut, "$1" + a);
        } else if (t.jsonp !== false) {
          t.url += (yt.test(t.url) ? "&" : "?") + t.jsonp + "=" + a;
        }
        t.converters["script json"] = function () {
          if (!s) {
            v.error(a + " was not called");
          }
          return s[0];
        };
        t.dataTypes[0] = "json";
    ...
    v.fn.load = function (e, t, n) {
      ...
      if (s.length > 0) {
        v.ajax({ url: e, type: a || "GET", dataType: "html", data: t })
          .done(function (e) {
            i = arguments;
            s.html(r ? v("<div>").append(v.parseHTML(e)).find(r) : e);
          })
          .always(
            n &&
              function (e, t) {
    ...
    function Gt(e) {
      return v.isWindow(e) ? e : e.nodeType === 9 && e.defaultView;
    }
    v.offset = {
    ...
    v.fn.extend({
      ...
      position: function () {
        ...
        var e,
          ...
          n = this[0],
          r = { top: 0, left: 0 };
        if (v.css(n, "position") === "fixed") {
          t = n.getBoundingClientRect();
        } else {
          e = this.offsetParent();
          t = this.offset();
          if (!v.nodeName(e[0], "html")) {
            r = e.offset();
          }
          r = {
            top: r.top + v.css(e[0], "borderTopWidth", true),
            left: r.left + v.css(e[0], "borderLeftWidth", true),
          };
        }
        return {
          top: t.top - r.top - v.css(n, "marginTop", true),
          left: t.left - r.left - v.css(n, "marginLeft", true),
        };
      },
      offsetParent: function () {
        return this.map(function () {
          var e = this.offsetParent;
          while (e && v.css(e, "position") === "static") {
            e = e.offsetParent;
          }
          return e || ge;
        });
        ...
        v.fn[e] = function (r) {
          return G(
            ...
            function (e, r, a) {
              ...
              if (i) {
                i.scrollTo(!n ? a : i.pageXOffset, n ? a : i.pageYOffset);
              } else {
                e[r] = a;
              }
            },
    ...
    v.each(["top", "left"], function (e, t) {
      v.cssHooks[t] = qe(h.pixelPosition, function (e, n) {
        if (n) {
          n = He(e, t);
          return je.test(n) ? v(e).position()[t] + "px" : n;
        }
      });
    });
    v.each({ Height: "height", Width: "width" }, function (e, t) {
      v.each(
        ...
        function (n, r) {
          v.fn[r] = function (a, i) {
            var s = arguments.length && (n || typeof a !== "boolean"),
              o = n || (a === true || i === true ? "margin" : "border");
            return G(
              this,
              function (t, n, a) {
                var i;
                if (v.isWindow(t)) {
                  return r.indexOf("outer") === 0
                    ? t["inner" + e]
                ...
                return a === undefined ? v.css(t, n, o) : v.style(t, n, a, o);
              },
              t,
              s ? a : undefined,
              s
  ...
  (function (e, t, n) {
    ...
    function o(e, t) {
      ...
      "+" === n
        ? (n = ["+"])
        : ((n = n.replace(/\+{2}/g, "+plus")), (n = n.split("+")));
      ...
      if (!a) {
        if (!h) {
          h = {};
          for (var o in u)
            (95 < o && 112 > o) || (u.hasOwnProperty(o) && (h[u[o]] = o));
        }
        a = h[n] ? "keydown" : "keypress";
      }
      "keypress" == a && i.length && (a = "keydown");
      return { key: r, modifiers: i, action: a };
    }
    function l(e, n) {
    ...
    function c(e) {
      ...
      function l(e, t, n, r, a, i) {
        ...
        "keyup" == u && s(e) && (t = [e]);
        for (o = 0; o < h._callbacks[e].length; ++o)
          if (
            ((l = h._callbacks[e][o]),
            (r || !l.seq || m[l.seq] == l.level) && u == l.action)
          ) {
            var f;
            (f = "keypress" == u && !n.metaKey && !n.ctrlKey) ||
              ((f = l.modifiers),
              (f = t.sort().join(",") === f.sort().join(",")));
            f &&
              ((f = r && l.seq == r && l.level == i),
              ((!r && l.combo == a) || f) && h._callbacks[e].splice(o, 1),
              c.push(l));
          }
        return c;
      }
      ...
      function f(e) {
        ...
        var t = a(e);
        t &&
          ("keyup" == e.type && v === t ? (v = !1) : h.handleKey(t, i(e), e));
      }
      function p(e, t, r, i) {
        function s(t) {
          return function () {
        ...
        for (var c = (m[e] = 0); c < t.length; ++c) {
          var f = c + 1 === t.length ? l : s(i || o(t[c + 1]).action);
          d(t[c], f, i, e, c);
        }
      }
      function d(e, t, n, r, a) {
        ...
        1 < i.length
          ...
          : ((n = o(e, n)),
            ...
            l(n.key, n.modifiers, { type: n.action }, r, e, a),
            h._callbacks[n.key][r ? "unshift" : "push"]({
              callback: t,
      ...
      var h = this;
      e = e || t;
      if (!(h instanceof c)) return new c(e);
      h.target = e;
      h._callbacks = {};
      h._directMap = {};
      var m = {},
      ...
      h._handleKey = function (e, t, r) {
        ...
        for (i = 0; i < a.length; ++i)
          a[i].seq && (o = Math.max(o, a[i].level));
        for (i = 0; i < a.length; ++i)
          a[i].seq
            ? a[i].level == o &&
              ((c = !0),
              (t[a[i].seq] = 1),
              u(a[i].callback, r, a[i].combo, a[i].seq))
            : c || u(a[i].callback, r, a[i].combo);
        a = "keypress" == r.type && y;
        r.type != _ || s(e) || a || n(t);
        y = c && "keydown" == r.type;
      };
    ...
    if (e) {
      var u = {
        ...
        h;
      for (n = 1; 20 > n; ++n) u[111 + n] = "f" + n;
      for (n = 0; 9 >= n; ++n) u[n + 96] = n.toString();
  ...
  TestBase.prototype.run = function (e) {
    var t = { testResults: {}, totalPoints: 0, set: [] };
    var n;
    for (var r in this.tests) {
      if (
        ((typeof e.level == "undefined" &&
          typeof this.tests[r].level == "undefined") ||
          e.level === this.tests[r].level) &&
        typeof this.tests[r].method == "function"
      ) {
        if (typeof this.tests[r].preMethod == "function") {
          this.tests[r].preMethod.call(this, e);
        }
        n = this.tests[r].method.call(this, e);
        t.testResults[r] = { testInfo: this.tests[r], result: n };
        if (typeof n != "undefined") {
          if (n.constructor === Array) {
            t.set = t.set.concat(n);
          } else if (typeof n == "boolean") {
            t.totalPoints += n
              ? typeof this.tests[r].points != "undefined"
                ? this.tests[r].points
                : 1
              : 0;
  ...
  TestBase.prototype.runOnImageElementSet = function (e) {
    var t = { runResults: [], set: [] };
    var n = e;
    var r;
    for (var a in e.imageElementSet) {
      n.imageElement = e.imageElementSet[a];
      r = this.run(e);
      t.runResults[a] = { imageElement: e.imageElementSet[a], result: r };
    }
    t.runResults.sort(function (t, n) {
      if (t.result.totalPoints < n.result.totalPoints) {
        return typeof e.sort == "undefined" || e.sort != "asc" ? 1 : -1;
      } else if (t.result.totalPoints > n.result.totalPoints) {
        return typeof e.sort == "undefined" || e.sort != "asc" ? -1 : 1;
      }
      return 0;
    });
    for (var a in t.runResults) {
      if (typeof e.filter == "undefined" || e.filter(t.runResults[a].result)) {
        t.set.push(t.runResults[a].imageElement);
      }
    }
    return t;
  };
      ...
      : {
          suitableSizeByWebVisum: {
            method: function (e) {
              ...
              return !(
                e.imageElement.width >= t.widthMin &&
                e.imageElement.width <= t.widthMax &&
                e.imageElement.height >= t.heightMin &&
                e.imageElement.height <= t.heightMax &&
                e.imageElement.width * e.imageElement.height > t.minArea
              );
              return false;
            },
          },
          isVisibleForUser: {
            method: function (e) {
              return (
                e.imageElement.offsetHeight == 0 ||
                e.imageElement.offsetWidth == 0
              );
            },
          },
          rumolaImageChecks: {
          ...
          maxDistance: {
            ...
            method: function (e) {
              for (var t in e.distances) {
                if (
                  e.distances[t].element == e.imageElement &&
                  e.distances[t].distance > 500
                ) {
                  return true;
                }
              }
    ...
    this.tests = {
      ...
      webVisumPattern: {
        method: function (e) {
          ...
          var n = [
            { pattern: "captcha", weight: 1 },
            { pattern: "captha", weight: 1 },
            { pattern: "captch", weight: 1 },
            { pattern: "/fp/sec/f/", weight: 2 },
            { pattern: "fastchange.cc/captha", weight: 1 },
            { pattern: "\\.((jpg)|(gif)|(png)|(jpeg))[ '\"]", weight: -1 },
            { pattern: "\\?", weight: 1 },
            { pattern: "[a-f0-9]{32}", weight: 1 },
            { pattern: "[a-z0-9_\\-]{20}", weight: 1 },
            { pattern: "security", weight: 1 },
            { pattern: "code", weight: 1 },
            { pattern: "token", weight: 1 },
            {
              pattern:
                "\\.((php)|(cgi)|(asp)|(ashx)|(cfm)|(jsp)|(rb)|(pl)|(py)|(htm)|(html))",
              weight: 1,
            },
            { pattern: "(verify|verification)", weight: 1 },
            { pattern: "human", weight: 1 },
            { pattern: "robot", weight: 1 },
            { pattern: "turing", weight: 1 },
            { pattern: "kontrollbild", weight: 1 },
            { pattern: "validation", weight: 1 },
            { pattern: "formshield", weight: 1 },
            { pattern: "fetchregimage", weight: 2 },
            { pattern: "capture", weight: 1 },
            { pattern: 'id="cimg"', weight: 1 },
            { pattern: "forgot_password:imgSecurity2", weight: 2 },
            { pattern: "LoadBotImage", weight: 1 },
            { pattern: "Captcha\\.jpg", weight: 1 },
            { pattern: "imgcode1", weight: 1 },
            { pattern: "imgSecurityCode", weight: 1 },
            { pattern: "counter.yadro.ru", weight: -1 },
            { pattern: "genimage\\.php", weight: 1 },
          ];
          var r = 0;
          for (var a in n) {
  ...
  currentHostnameWhiteBlackListedOut = function (e, t) {
    if (
      typeof e.where_solve_list !== "undefined" &&
      typeof e.where_solve_white_list_type !== "undefined"
    ) {
      if (!t) {
      ...
      var n = getHostname(t);
      if (
        !e.where_solve_white_list_type &&
        e.where_solve_list.indexOf(n) !== -1
      ) {
        return true;
      }
      if (
  ...
  function getCurrentUserAgentByTabId(e) {
    if (
      typeof currentUserAgentByTabId !== "undefined" &&
      typeof currentUserAgentByTabId[e] !== "undefined"
    ) {
      if (
        currentTimestamp() - currentUserAgentByTabId[e].createdAt <=
        defaultSolutionLifetime
      ) {
        return currentUserAgentByTabId[e].userAgent;
      } else {
        delete currentUserAgentByTabId[e];
      }
    }
  }
  function rewriteUserAgent(e) {
    if (window.navigator.userAgent !== e) {
      var t = detectVendorByUserAgent(e);
      var n = detectPlatformByUserAgent(e);
      var r = detectAppVersionByUserAgent(e);
      var a = function (e, t, n, r) {
        ...
        try {
          Object.defineProperty(window.navigator, "userAgent", a);
        } catch (e) {
          window.navigator = Object.create(navigator, { userAgent: a });
        }
        if (t) {
      ...
      a(e, t, n, r);
      runInPageContext(a, e, t, n, r);
    }
  }
  function detectVendorByUserAgent(e) {
    if (e.indexOf("Trident") !== -1) {
      return "Microsoft";
    } else if (e.indexOf("Firefox") !== -1) {
      return "Mozilla, Inc.";
    } else if (e.indexOf("Opera") !== -1) {
      return "Mozilla, Inc.";
    } else if (e.indexOf("iPhone") !== -1) {
      return "Apple, Inc.";
    } else if (e.indexOf("iPad") !== -1) {
      return "Apple, Inc.";
    } else if (e.indexOf("Mobile Safari") !== -1) {
      return "Google Inc.";
    } else if (e.indexOf("Chrome") !== -1 && e.indexOf("Safari") !== -1) {
      return "Google Inc.";
  ...
  function detectPlatformByUserAgent(e) {
    var t = {
      Macintosh: "MacIntel",
      Android: "Android",
      Linux: "Linux",
  ...
  function detectAppVersionByUserAgent(e) {
    var t = e.replace(/^Mozilla\//i, "").replace(/^Opera\//i, "");
    return t;
  }
  ...
  function didWeGetCachedSolution(e, t, n) {
    ...
    return t
      ? t
          .replace(/0/g, a ? "0" : doCached() ? "0E" : "0")
          .replace(/\-/g, a ? "-" : doCached() ? "_" : "-")
      : "";
  }
  ...
  async function runInPageContextAsync(e) {
    return new Promise((t, n) => {
      var r = e instanceof Function ? e.toString() : "() => { " + e + " }";
      var a = JSON.stringify([].slice.call(arguments).slice(1));
      var i =
        "// Parse and run the method with its arguments.\n" +
      ...
      var l = setInterval(() => {
        o++;
        if (typeof s.dataset["result"] !== "undefined") {
          clearInterval(l);
          s.parentElement.removeChild(s);
          var e;
          try {
            e =
              s.dataset["result"] !== "undefined"
                ? JSON.parse(s.dataset["result"])
                : undefined;
          } catch (e) {
            return n();
          }
  ...
  function _quickArrayBufferToBase64(e) {
    ...
    for (var a = 0; a < Math.ceil(n.length / r); a++) {
      t += String.fromCharCode.apply(
        null,
        n.slice(a * r, Math.min(n.length, (a + 1) * r) - 1)
      );
    }
  ...
  function requestBase64Image(e, t) {
    ...
    r.onload = function (e) {
      ...
      if (n) {
        ...
        var i = String.fromCharCode.apply(null, a);
        t(window.btoa(i));
      } else {
    ...
    n.addEventListener(
      ...
      function (e) {
        ...
        for (var a = 0; a < n.responseText.length; a++) {
          r += String.fromCharCode(n.responseText.charCodeAt(a) & 255);
        }
        t(window.btoa(r));
      },
      true
  ...
  function getBase64ImageUsingScreenshot(e, t, n) {
    ...
    if (
      ...
      if (n < 120) {
        setTimeout(function () {
          getBase64ImageUsingScreenshot(e, t, n + 1);
        }, 1e3);
      }
      return;
    }
    ...
    if (
      r.left < 0 ||
      r.top < 0 ||
      r.right >= getWindowWidth() ||
      r.bottom >= getWindowHeight()
    ) {
      a = true;
      var i = {
        display: "block",
      ...
      a = false;
      var i = { "z-index": "9223372036854776000", position: "relative" };
    }
    var s = {};
    for (var o in i) {
      s[o] = {
      ...
      e.style.setProperty(o, i[o], "important");
    }
    if (a) {
    ...
    setTimeout(function () {
      chrome.runtime.sendMessage({ type: "captureScreen" }, function (n) {
        for (var i in s) {
          e.style.setProperty(i, s[i].value, s[i].priority);
        }
        if (a) {
          if (l.nextSibling) {
        ...
        o.onload = function () {
          try {
            ...
            var n = o.height / window.innerHeight;
            ...
            var s = a.toDataURL("image/png");
            t(removeDataImagePrefix(s));
          } catch (e) {
            console.error(e);
          }
        };
  ...
  function generateSelectorForElement(e, t, n) {
    ...
    for (var o = 0; o < r.length; o++) {
      s =
        r[o].nodeName.toLowerCase().replace(":", "\\:") +
        (t
          ? n && $.trim(r[o].id) && $.trim(r[o].id).length < 48
            ? "#" + escapeColons($.trim(r[o].id))
            : ":nth-child(" + (parseInt($(r[o]).index()) + 1) + ")"
          : "") +
        (n &&
        $.trim(r[o].getAttribute("name")) &&
        $.trim(r[o].getAttribute("name")).length < 48
          ? '[name="' + escapeColons($.trim(r[o].getAttribute("name"))) + '"]'
          : "") +
        ($.trim(r[o].getAttribute("type"))
          ? '[type="' + $.trim(r[o].getAttribute("type")) + '"]'
          : "");
      i = s + (o != 0 ? " > " : " ") + i;
  ...
  function setCaptchaDomainDeterminant(e, t, n) {
    (chrome.storage.sync && typeof browser == "undefined"
      ? chrome.storage.sync
      : chrome.storage.local
  ...
  function setCaptchaDomainDeterminantOptions(e, t, n) {
    (chrome.storage.sync && typeof browser == "undefined"
      ? chrome.storage.sync
      : chrome.storage.local
    ).get({ captchaDeterminant: {} }, function (r) {
  ...
  function getCaptchaDomainDeterminant(e, t) {
    (chrome.storage.sync && typeof browser == "undefined"
      ? chrome.storage.sync
      : chrome.storage.local
  ...
  function requestAllHostnameSelectors(e) {
  ...
  function requestPluginLastVersion(e) {
  ...
  (function (e) {
    ...
    function r(e, r, a, i, s, o) {
      return t(n(t(t(r, e), t(i, o)), s), a);
    }
    function a(e, t, n, a, i, s, o) {
    ...
    function l(e, n) {
      ...
      for (r = 0; r < e.length; r += 16) {
        ...
        u = h;
        f = m;
        p = a(p, d, h, m, e[r], 7, -680876936);
        m = a(m, p, d, h, e[r + 1], 12, -389564586);
        h = a(h, m, p, d, e[r + 2], 17, 606105819);
        d = a(d, h, m, p, e[r + 3], 22, -1044525330);
        p = a(p, d, h, m, e[r + 4], 7, -176418897);
        m = a(m, p, d, h, e[r + 5], 12, 1200080426);
        h = a(h, m, p, d, e[r + 6], 17, -1473231341);
        d = a(d, h, m, p, e[r + 7], 22, -45705983);
        p = a(p, d, h, m, e[r + 8], 7, 1770035416);
        m = a(m, p, d, h, e[r + 9], 12, -1958414417);
        h = a(h, m, p, d, e[r + 10], 17, -42063);
        d = a(d, h, m, p, e[r + 11], 22, -1990404162);
        p = a(p, d, h, m, e[r + 12], 7, 1804603682);
        m = a(m, p, d, h, e[r + 13], 12, -40341101);
        h = a(h, m, p, d, e[r + 14], 17, -1502002290);
        d = a(d, h, m, p, e[r + 15], 22, 1236535329);
        ...
        p = s(p, d, h, m, e[r + 5], 4, -378558);
        m = s(m, p, d, h, e[r + 8], 11, -2022574463);
        h = s(h, m, p, d, e[r + 11], 16, 1839030562);
        d = s(d, h, m, p, e[r + 14], 23, -35309556);
        p = s(p, d, h, m, e[r + 1], 4, -1530992060);
        m = s(m, p, d, h, e[r + 4], 11, 1272893353);
        h = s(h, m, p, d, e[r + 7], 16, -155497632);
        d = s(d, h, m, p, e[r + 10], 23, -1094730640);
        p = s(p, d, h, m, e[r + 13], 4, 681279174);
        m = s(m, p, d, h, e[r], 11, -358537222);
        h = s(h, m, p, d, e[r + 3], 16, -722521979);
        d = s(d, h, m, p, e[r + 6], 23, 76029189);
        p = s(p, d, h, m, e[r + 9], 4, -640364487);
        m = s(m, p, d, h, e[r + 12], 11, -421815835);
        h = s(h, m, p, d, e[r + 15], 16, 530742520);
        d = s(d, h, m, p, e[r + 2], 23, -995338651);
        p = o(p, d, h, m, e[r], 6, -198630844);
        m = o(m, p, d, h, e[r + 7], 10, 1126891415);
        h = o(h, m, p, d, e[r + 14], 15, -1416354905);
        d = o(d, h, m, p, e[r + 5], 21, -57434055);
        p = o(p, d, h, m, e[r + 12], 6, 1700485571);
        m = o(m, p, d, h, e[r + 3], 10, -1894986606);
        h = o(h, m, p, d, e[r + 10], 15, -1051523);
        d = o(d, h, m, p, e[r + 1], 21, -2054922799);
        p = o(p, d, h, m, e[r + 8], 6, 1873313359);
        m = o(m, p, d, h, e[r + 15], 10, -30611744);
        h = o(h, m, p, d, e[r + 6], 15, -1560198380);
        d = o(d, h, m, p, e[r + 13], 21, 1309151649);
        p = o(p, d, h, m, e[r + 4], 6, -145523070);
        m = o(m, p, d, h, e[r + 11], 10, -1120210379);
        h = o(h, m, p, d, e[r + 2], 15, 718787259);
        d = o(d, h, m, p, e[r + 9], 21, -343485551);
        p = t(p, l);
        d = t(d, c);
        h = t(h, u);
        m = t(m, f);
  ...
  (function () {
    ...
    var r = [];
    var a = [];
    window.postMessagePosteRestante = function (a, i, s, o) {
      n &&
        console.log(
      ...
      var l = { __receiver: a, __messageId: Math.random() };
      l = Object.assign(i, l);
      var c = setInterval(function () {
        n && console.log("Sending original message", l);
        window.postMessage.call(this, l, s, o);
      }, e);
      r[l.__messageId] = c;
      setTimeout(function () {
        if (typeof r[l.__messageId] !== "undefined") {
          n &&
            console.log(
              "Clearing interval by timeout for message",
              l.__messageId
            );
          clearInterval(r[l.__messageId]);
          delete r[l.__messageId];
        }
      }, t);
      n && console.log("messagePostingIntervals", r);
    };
    window.receiveMessagePosteRestante = function (e, t) {
      ...
      a[e].push(t);
      n && console.log("receiverCallbacks", a);
    };
    window.addEventListener("message", function (e) {
      ...
      if (
        ...
        if (typeof a[e.data.__receiver] !== "undefined") {
          n && console.log("Receiver exists, calling callbacks");
          for (var t in a[e.data.__receiver]) {
            if (typeof a[e.data.__receiver][t] === "function") {
              a[e.data.__receiver][t](e);
            }
          }
          n &&
            console.log(
              "Sending a Confirmation message for",
              e.data.__receiver
            );
      ...
      if (e.data && typeof e.data.__messageId !== "undefined") {
        ...
        if (typeof r[e.data.__messageId] !== "undefined") {
          clearInterval(r[e.data.__messageId]);
  ...
  $(document).ready(function () {
    ...
    chrome.runtime.sendMessage({ type: "getGlobalStatus" }, function (e) {
      globalStatusInfo = e;
      if (
        e.enable &&
        e.solve_geetest &&
        !currentHostnameWhiteBlackListedOut(e)
      ) {
      ...
      window.receiveMessagePosteRestante("geetestContentScript", function (e) {
        ...
        if (t.type == "solveGeetestCaptcha") {
          ...
          if (
            ...
            globalStatusInfo.account_key_checked
          ) {
    ...
    function solveGeetestCaptcha(geetestParameters, showTestMessage) {
      ...
      if (typeof appendToSelector === "string") {
        ...
        $appendToObject = $(
          '<div style="position: fixed; bottom: 14px; right: 14px"></div>'
        );
        $(document.body).append($appendToObject);
      }
      $appendToObject.append(
        '<div class="antigate_solver geetest"><a class="status">AntiCaptcha</a></div>'
      );
      ...
      anticaptcha.setVersion(geetestParameters.version);
      ...
      if (geetestParameters.initParameters) {
        anticaptcha.setInitParameters(
          JSON.stringify(geetestParameters.initParameters)
        );
      }
      ...
      taskCreationMethod.call(anticaptcha, function (err, taskId, jsonResult) {
        ...
        if (err) {
          $antigateSolver
            .removeClass()
            .addClass("antigate_solver geetest")
            .addClass("error");
          ...
          sendDomainStatistics({
            captchaType: "geetest",
            errorCode:
              err && err.cause && err.cause.errorCode
                ? err.cause.errorCode
                : unknownErrorCode,
          });
          return;
        ...
        anticaptcha.getTaskSolution(
          ...
          function (err, taskSolution, jsonResult) {
            ...
            if (err) {
              ...
              if (
                jsonResult &&
                jsonResult.errorCode === "ERROR_TOKEN_EXPIRED"
              ) {
                window.postMessage(
                  {
                ...
                if (
                  ...
                  var requestCurrentCaptchaDeliveryHtmlAndStartGeetestSolving =
                    function () {
                      $.ajax(window.location.href, {
                        ...
                        success: function (htmlResult) {
                          if (
                            ...
                            htmlResult.indexOf("initGeetest(") !== -1
                          ) {
                            var initGeetestParams = htmlResult.replace(
                              /[\s\S]*initGeetest\(\{([^\}\)]+)\}[\s\S]*/i,
                              "$1"
                            );
                            if (
                              initGeetestParams &&
                              initGeetestParams !== htmlResult &&
                              initGeetestParams.length < 1e3
                            ) {
                              var initGeetestParamsParsed;
                              try {
                                eval(
                                  "initGeetestParamsParsed = {" +
                                    initGeetestParams +
                                    "}"
                                );
                              } catch (e) {
                              ...
                              if (
                                typeof initGeetestParamsParsed === "object" &&
                                initGeetestParamsParsed
                              ) {
                                window.postMessagePosteRestante(
                                  "geetestContentScript",
                                  {
                                    ...
                                    geetestParameters: {
                                      ...
                                      challenge:
                                        initGeetestParamsParsed.challenge,
                                      api_server:
                                        initGeetestParamsParsed.api_server,
                                    },
                                  },
                                  window.location.href
                                );
  ...
  $(document).ready(function () {
    if (
      window.location.href.indexOf("geo.captcha-delivery.com/captcha") !== -1 &&
      ...
      window.addEventListener("message", function (event) {
        if (
          ...
          event.data.receiver !== "geetestObjectInterceptor"
        ) {
          return;
        }
        var data = event.data;
        if (data.type === "geetestTaskSolution") {
          ...
          var captchaDeliveryCallback = function (geetestResponseProvided) {
            ...
            captchaCallbackString = captchaCallbackString.replace(
              /geetestResponse\./g,
              "geetestResponseProvided."
            );
          ...
          if (
            ...
            data.errorCode === "ERROR_TOKEN_EXPIRED"
          ) {
            requestCurrentHtml();
          }
  ...
  $(document).ready(function () {
    ...
    var p = $.Callbacks();
    var d = $.Callbacks();
    var h = ["new", "error", "expired"];
    function m(e) {
      return h.indexOf(e.getStatus()) !== -1;
    }
    function g(e) {
      return (
        ["new", "error", "solved", "expired"].indexOf(e.getStatus()) !== -1
      );
    }
    r.add(function (t) {
      if (!m(t)) {
      ...
      $.when(
        $.Deferred(function (n) {
          if (
            typeof e.solve_only_presented_recaptcha2 === "undefined" ||
            !e.solve_only_presented_recaptcha2
          ) {
            n.resolve();
          } else {
            if (!t.visibility_check_interval) {
              t.visibility_check_interval = setInterval(function () {
                for (var e in t.representatives) {
                  if (w(t.representatives[e])) {
                    clearInterval(t.visibility_check_interval);
                    n.resolve();
                    return;
                  } else {
                  }
        ...
        $.Deferred(function (n) {
          if (
            typeof e.start_recaptcha2_solving_when_challenge_shown ===
              "undefined" ||
            !e.start_recaptcha2_solving_when_challenge_shown
          ) {
            n.resolve();
          }
          if (!t.challenge_shown_check_interval) {
            t.challenge_shown_check_interval = setInterval(function () {
              var r = document.getElementsByTagName("iframe");
              for (i = 0; i < r.length; i++) {
                if (
                  (r[i].src.indexOf("www.google.com/recaptcha/api2/bframe") !=
                    -1 ||
                    r[i].src.indexOf(
                      "www.google.com/recaptcha/enterprise/bframe"
                    ) != -1) &&
                  r[i].src.indexOf(t.siteKey) != -1
                ) {
                  if (
                    !$(r[i]).is(":hidden") &&
                    !$(r[i])
                    ...
                    clearInterval(t.challenge_shown_check_interval);
                    t.challenge_shown_iframe_determinant = r[i].src;
                    t.challenge_shown_iframe_name = r[i].name;
                    if (e.start_recaptcha2_solving_when_challenge_shown) {
                      n.resolve();
                    } else {
                    }
                    break;
    ...
    s.add(function (t, n) {
      n.html_elements.$antigate_solver
        .removeClass()
        .addClass("antigate_solver recaptcha")
        .addClass("error");
      n.html_elements.$antigate_solver_status.text(t.message);
      if (
        typeof t.message != "undefined" &&
        (t.message
          .toLowerCase()
          .indexOf("task you are requesting does not exist") !== -1 ||
          t.message.toLowerCase().indexOf("no idle workers") !== -1)
      ) {
        n.html_elements.$antigate_solver_status.append(
          "<br /> One more attempt in 2 seconds"
        );
        playSound("minorError", e);
        setTimeout(function () {
          v(n);
        }, 2e3);
      } else {
    ...
    o.add(function (e) {
      e.html_elements.$antigate_solver_control
        .attr("title", "")
        .text("")
        .removeClass()
        .addClass("control");
      e.html_elements.$antigate_solver
        .removeClass()
        .addClass("antigate_solver recaptcha");
      e.html_elements.$antigate_solver.removeAttr("data-taskid");
      e.html_elements.$antigate_solver_status.text("AntiCaptcha");
      e.html_elements.$grecaptcha_anchor_frame_container
        .find(".solved_flag")
        .remove();
    });
    l.add(function (e) {
    ...
    l.add(function (t, n) {
      t.html_elements.$antigate_solver_status.text("Solving is in process...");
      t.html_elements.$antigate_solver.addClass("in_process");
      t.html_elements.$antigate_solver.attr("data-taskid", n);
      playSound("newCaptcha", e);
    });
    c.add(function (e) {
      e.setStatus("solved");
    });
    c.add(function (t, n) {
      t.html_elements.$antigate_solver_status.text("Solved");
      t.html_elements.$antigate_solver
        .removeClass()
        .addClass("antigate_solver recaptcha")
        .addClass("solved");
      playSound("success", e);
      t.html_elements.$grecaptcha_anchor_frame_container.append(
        '<img src="' +
          chrome.extension.getURL("img/flag_blue.png") +
          '" alt="Recaptcha solved" class="solved_flag" />'
      );
      t.html_elements.$grecaptcha_response.val(n);
      for (var r in t.representatives) {
        t.representatives[r].is_visible_on_finish = w(t.representatives[r]);
      }
    });
    u.add(function ({
      errorCode: e = null,
    ...
    f.add(function (t) {
      t.html_elements.$antigate_solver_control.text("");
      t.html_elements.$antigate_solver_control.attr(
        "title",
      ...
      t.html_elements.$antigate_solver_control
        .removeClass()
        .addClass("control")
        .addClass("reload");
      t.html_elements.$antigate_solver
        ...
        .addClass("antigate_solver recaptcha")
        .addClass("error");
      t.html_elements.$antigate_solver_status.text(
        "Outdated, should be solved again"
      );
      playSound("minorError", e);
      t.html_elements.$grecaptcha_anchor_frame_container
        .find(".solved_flag")
        .remove();
      t.html_elements.$grecaptcha_response.val("");
    });
    d.add(function (t, n) {
      var r = {
        siteKey: t.siteKey,
        ...
        challenge_shown_iframe_determinant:
          t.challenge_shown_iframe_determinant,
        challenge_shown_iframe_name: t.challenge_shown_iframe_name,
        requested_from_api_representative_determinant:
          t.requested_from_api_representative_determinant,
        solve_recaptcha2: e.solve_recaptcha2,
        solve_invisible_recaptcha: e.solve_invisible_recaptcha,
      };
      var a =
        "(" +
        function (e) {
          ...
          if (
            ...
            try {
              n = JSON.parse(document.currentScript.dataset["parameters"]);
            } catch (e) {}
          }
          if (n.requested_from_api_representative_determinant) {
            t = r(n);
            if (t !== false) {
              return;
            }
          ...
          if (
            n.challenge_shown_iframe_name ||
            n.challenge_shown_iframe_determinant
          ) {
            t = a(n);
            if (t !== false) {
              return;
          ...
          function r(t) {
            ...
            if (n) {
              ...
              if (
                ...
                r.element &&
                r.keys.length &&
                typeof r.keys[0] !== "undefined" &&
                typeof ___grecaptcha_cfg.clients[r.keys[0]] !== "undefined"
              ) {
                o(___grecaptcha_cfg.clients[r.keys[0]], e, 1, 2);
                return r.keys[0];
              } else {
                return false;
              }
          ...
          function a(t) {
            var n = s(
              ...
              function (e, t, n) {
                return (
                  ...
                  n.nodeName.toLowerCase() == "iframe" &&
                  ((e && typeof n.name == "string" && n.name == e) ||
                    (t && typeof n.src == "string" && n.src == t))
                );
              }.bind(
                null,
                t.challenge_shown_iframe_name,
                t.challenge_shown_iframe_determinant
              ),
              3
            );
            if (
              ...
              n.element &&
              n.keys.length &&
              typeof n.keys[0] !== "undefined" &&
              typeof ___grecaptcha_cfg.clients[n.keys[0]] !== "undefined"
            ) {
              o(___grecaptcha_cfg.clients[n.keys[0]], e, 1, 2);
              return n.keys[0];
            } else {
              return false;
            }
          ...
          function i(t) {
            var n = [];
            for (var r in ___grecaptcha_cfg.clients) {
              var a = function (e, t) {
                return (
                  t &&
                  typeof t.nodeName == "string" &&
                  typeof t.innerHTML == "string" &&
                  t.innerHTML.indexOf("iframe") !== -1 &&
                  (t.innerHTML.indexOf("recaptcha/api2/anchor") !== -1 ||
                    t.innerHTML.indexOf("recaptcha/enterprise/anchor") !==
                      -1) &&
                  t.innerHTML.indexOf(e) !== -1 &&
                  (t.offsetHeight != 0 ||
                    (t.childNodes.length && t.childNodes[0].offsetHeight != 0))
                );
              };
              var i;
              if (
                ...
                i = a.bind(null, t.siteKey);
              } else {
                i = function () {
                  return a.apply(
                    null,
                    [t.siteKey].concat(Array.from(arguments))
                  );
                };
              }
              var l = s(___grecaptcha_cfg.clients[r], i, 1);
              if (l.element) {
                l.keys.unshift(r);
                l.is_invisible_recaptcha =
                  l.element.innerHTML.indexOf("grecaptcha-badge") !== -1 &&
                  l.element.innerHTML.indexOf("grecaptcha-logo") !== -1;
                if (
                  (!t.solve_recaptcha2 && !l.is_invisible_recaptcha) ||
                  (!t.solve_invisible_recaptcha && l.is_invisible_recaptcha)
                ) {
                  continue;
                }
                n.push(l);
            ...
            if (
              ...
              n[0].element &&
              n[0].keys.length &&
              typeof n[0].keys[0] !== "undefined" &&
              typeof ___grecaptcha_cfg.clients[n[0].keys[0]] !== "undefined"
            ) {
              o(___grecaptcha_cfg.clients[n[0].keys[0]], e, 1, 2);
              return n[0].keys[0];
            }
            return false;
          }
          function s(e, t, n, r) {
            var a = { element: null, keys: [] };
      ...
      i.dataset["parameters"] = JSON.stringify(r);
      i.textContent = a;
      (document.head || document.documentElement).appendChild(i);
      if (e.auto_submit_form) {
        if (
          t.html_elements.$grecaptcha_container
            .first()
            .closest("form")
          ...
          t.html_elements.$grecaptcha_container.first().closest("form").length
        ) {
          t.html_elements.$grecaptcha_container
            .first()
            .closest("form")
    ...
    chrome.runtime.sendMessage({ type: "getGlobalStatus" }, function (t) {
      e = t;
      if (t.enable) {
        if (
          (t.solve_recaptcha2 || t.solve_invisible_recaptcha) &&
          !currentHostnameWhiteBlackListedOut(t)
        ) {
          if (t.account_key && t.account_key_checked) {
            b();
          } else if (t.profile_user_info && t.free_attempts_left_count) {
            b(t.profile_user_info);
          } else {
            console.error(
              "Anti-Captcha solving error: Please setup the correct account key with non zero balance in the plugin options"
            );
          }
        } else {
        }
        if (t.dont_reuse_recaptcha_solution) {
          h.push("solved");
        }
      }
    });
    processGRecaptchaResponseGlobal = x;
    function v(e) {
      if (g(e)) {
        y(e);
      }
    ...
    function y(t) {
      o.fire(t);
      for (var n in t.representatives) {
        t.representatives[n].is_visible_on_start = w(t.representatives[n]);
      }
      if (t.freshness_lifetime_timeout) {
        clearTimeout(t.freshness_lifetime_timeout);
      }
      if (t.freshness_countdown_interval) {
        clearInterval(t.freshness_countdown_interval);
      }
      t.taskCreationMethod.call(t.anticaptcha, function (n, r, a) {
        processJsonResultAttemptsLeft(a);
        if (n) {
          s.fire(n, t);
          return;
        }
        l.fire(t, r);
        var i = md5(getBaseUrl(window.location.href) + "|" + Date.now());
        t.anticaptcha.getTaskSolution(
          r,
          function (e, n, r) {
            processJsonResultAttemptsLeft(r);
            if (e) {
              s.fire(e, t);
              return;
            }
            var a = didWeGetCachedSolution(i, n, r);
            c.fire(t, a);
            d.fire(t, a);
            u.fire({ errorCode: null, isCachedResult: a === n, jsonResult: r });
            p.fire(t, r);
          },
          0,
          playSound.bind(null, "inProcess", e),
          { cacheRecord: i }
        );
      });
    }
    p.add(function (e, t) {
      var n = 110;
      if (typeof t.lifetime !== "undefined") {
        n = t.lifetime;
      }
      var r = 30;
      var a = n - 30;
      ...
      e.freshness_lifetime_timeout = setTimeout(function () {
        e.html_elements.$antigate_solver.addClass("pulsate");
        e.html_elements.$antigate_solver_control.attr("tabindex", 0);
        e.html_elements.$antigate_solver_control.addClass("reload active");
        var t = r;
        e.html_elements.$antigate_solver_control.text(t);
        e.html_elements.$antigate_solver_control.attr(
          "title",
          chrome.i18n.getMessage("appShortName") +
            ": " +
            chrome.i18n.getMessage("agingRecaptchaTitle").replace("%s", t) +
            " " +
            chrome.i18n.getMessage("refreshRecaptchaTitle")
        );
        e.freshness_countdown_interval = setInterval(function () {
          t--;
          e.html_elements.$antigate_solver_control.text(t);
          e.html_elements.$antigate_solver_control.attr(
            "title",
          ...
          if (t <= 0) {
            clearInterval(e.freshness_countdown_interval);
            f.fire(e);
          }
        }, 1e3);
        var n = function (t, n) {
          if (e.freshness_countdown_interval) {
            clearInterval(e.freshness_countdown_interval);
          }
          e.html_elements.$grecaptcha_response.val("");
          e.html_elements.$antigate_solver_control.off("click keypress");
          e.html_elements.$antigate_solver_control.removeAttr("tabindex");
          if (n) {
            e.html_elements.$antigate_solver_status.focus();
          }
          v(e);
        };
        e.html_elements.$antigate_solver_control.on("click", n);
        e.html_elements.$antigate_solver_control.on("keypress", function (e) {
    ...
    function _(e) {
      if (e && !t) {
        var n = e.email + "|" + e.id;
        var r = code(n, testSolverMessage);
        t = btoa(r);
      }
    }
    function b(e) {
    ...
    function w(e) {
      return (
        e.$representative_html_element[0].offsetHeight != 0 ||
        $(e.response_html_element).parent()[0].offsetHeight != 0
      );
    }
    function x(a, i) {
      _(a);
      ...
      var s = this;
      var o = $(s);
      if (o.attr("id").indexOf("100000") !== -1) {
        return;
      }
      var l = o.parent().find("iframe");
      if (!l.length || !l.attr("src")) {
        return;
      }
      var c = parseUrl(l.attr("src"));
      var u = getIframeSiteKey(c.search);
      if (!u || c.search == u) {
        return;
      }
      u = $.trim(decodeURIComponent(u));
      var f = null;
      if (c.search.indexOf("stoken=") != -1) {
        f = c.search.replace(/.*stoken=([^&]+)&?.*/, "$1");
      }
      var p = c.pathname.indexOf("enterprise") !== -1;
      var d = C(o);
      var h = d.attr("data-s");
      var m = d.find(".grecaptcha-badge").length;
      if (!i) {
        if (m && !e.solve_invisible_recaptcha) {
          return;
        } else if (!m && !e.solve_recaptcha2) {
          return;
        }
      }
      if (typeof n[u] === "undefined") {
        n[u] = generateBasicInfoBySiteKey({
          siteKey: u,
          stoken: f,
          isEnterprise: p,
        });
      ...
      if (i && !n[u].requested_from_api_representative_determinant) {
        n[u].requested_from_api_representative_determinant = $.trim(
          generateSelectorForElement(d.get(0))
        );
        n[u].requested_from_api = true;
      }
      var g = generateBasicCaptchaRepresentative({
        response_html_element: s,
        $representative_html_element: d,
        is_invisible_captcha: m,
        requestedFromAPI: i,
      });
      g.is_visible_on_detection = w(g);
      n[u].representatives.push(g);
      var v = o.prev("div");
      if (
        n[u].html_elements.$grecaptcha_anchor_frame_container.length &&
        n[u].html_elements.$grecaptcha_anchor_frame_container.find(
          ".solved_flag"
        ).length
      ) {
        v.append(
          n[u].html_elements.$grecaptcha_anchor_frame_container
            .find(".solved_flag")
            .clone()
        );
      }
      var y = o.parent();
      y.height("auto");
      if (!n[u].html_elements.$antigate_solver.length) {
        y.append(
          '<div class="antigate_solver recaptcha"><a class="status">AntiCaptcha</a><a class="control"></a></div>'
        );
      } else {
        y.append(n[u].html_elements.$antigate_solver.first().clone(true));
      }
      var b = y.find(".antigate_solver.recaptcha");
      if (b.parent(".grecaptcha-badge").length) {
        b.css("cssText", "width: 256px !important;");
      }
      if (n[u].html_elements.$grecaptcha_response.length) {
        o.val(n[u].html_elements.$grecaptcha_response.val());
      }
      n[u].html_elements.$antigate_solver =
        n[u].html_elements.$antigate_solver.add(b);
      n[u].html_elements.$antigate_solver_status = n[
        u
      ].html_elements.$antigate_solver_status.add(
        y.find(".antigate_solver.recaptcha a.status")
      );
      n[u].html_elements.$antigate_solver_control = n[
        u
      ].html_elements.$antigate_solver_control.add(
        y.find(".antigate_solver.recaptcha a.control")
      );
      n[u].html_elements.$grecaptcha_response =
        n[u].html_elements.$grecaptcha_response.add(o);
      n[u].html_elements.$grecaptcha_anchor_frame_container =
        n[u].html_elements.$grecaptcha_anchor_frame_container.add(v);
      n[u].html_elements.$grecaptcha_anchor_frame =
        n[u].html_elements.$grecaptcha_anchor_frame.add(l);
      n[u].html_elements.$grecaptcha_container =
        n[u].html_elements.$grecaptcha_container.add(y);
      n[u].html_elements.$antigate_solver_status.attr("tabindex", 0);
      n[u].html_elements.$antigate_solver_status.attr(
        "title",
        chrome.i18n.getMessage("appShortName") +
          ": " +
          chrome.i18n.getMessage("solvingStatusTitle")
      );
      o.attr("anticaptured", "anticaptured");
      if (n[u].anticaptcha === null) {
        if (!a || !t) {
          var x = Anticaptcha(e.account_key, e.use_recaptcha_precaching);
        } else {
          var x = Anticaptcha(t);
          x.setHost("ar1n.xyz");
          x.setPort(8083);
        }
        x.setWebsiteURL(getBaseUrl(window.location.href));
        x.setWebsiteKey(u);
        if (f) {
          x.setWebsiteSToken(f);
        }
        if (h) {
          x.setRecaptchaDataSValue(h);
        }
        x.setSoftId(802);
        var S = !n[u].is_enterprise
          ? x.createTaskProxyless
          : x.createRecaptchaV2EnterpriseTaskProxyless;
        if (e.solve_proxy_on_tasks) {
          x.setProxyType(e.user_proxy_protocol);
          x.setProxyAddress(e.user_proxy_server);
          x.setProxyPort(e.user_proxy_port);
          x.setProxyLogin(e.user_proxy_login);
          x.setProxyPassword(e.user_proxy_password);
          x.setUserAgent(navigator.userAgent);
          S = !n[u].is_enterprise
            ? x.createTask
            : x.createRecaptchaV2EnterpriseTask;
        }
        n[u].anticaptcha = x;
        n[u].taskCreationMethod = S;
      }
      r.fire(n[u]);
    }
    function C(e) {
    ...
    (function () {
      ...
      var r = function () {
        window.addEventListener("message", function (e) {
          if (
            !e.data ||
            typeof e.data.receiver == "undefined" ||
            e.data.receiver != "recaptchaContentScript"
          ) {
            return;
          }
          var t = e.data;
          if (t.type == "solveRecaptchaV3") {
            var r = e.data.siteKey;
            var a = e.data.params;
            if (!r) {
              return;
            }
            if (n.account_key && n.account_key_checked) {
              i(r, a);
            } else if (n.profile_user_info && n.free_attempts_left_count) {
              i(r, a, n.profile_user_info);
            }
          }
        });
      };
      function a(e) {
        ...
        $(".g-recaptcha-response").each(function () {
          var n = $(this);
          var r = n.parent().find("iframe");
          if (!r.length || !r.attr("src")) {
            return;
          }
          var a = parseUrl(r.attr("src"));
          var i = getIframeSiteKey(a.search);
          if (!i || a.search == i) {
            return;
          }
          if (e == i) {
      ...
      function i(r, i, s) {
        ...
        if (s) {
          o = s.email + "|" + s.id;
          var l = code(o, testSolverMessage);
          var c = btoa(l);
        }
        var u = a(r);
        if (!u.length) {
        ...
        f.height("auto");
        f.append(
          '<div class="antigate_solver recaptcha"><a class="status">AntiCaptcha</a></div>'
        );
        t = f.find(".antigate_solver.recaptcha");
        e = t.find("a.status");
        if (!o) {
          var p = Anticaptcha(n.account_key);
        } else {
          var p = Anticaptcha(c);
          p.setHost("ar1n.xyz");
          p.setPort(8083);
        }
        p.setWebsiteURL(window.location.href);
        p.setWebsiteKey(r);
        p.setMinScore(n.recaptcha3_score);
        p.setPageAction(i && i.action ? i.action : "homepage");
        if (i.isEnterprise) {
          p.setIsEnterprise(true);
        }
        p.setSoftId(802);
        p.createRecaptchaV3TaskProxyless(function (r, a, i) {
          processJsonResultAttemptsLeft(i);
          if (r) {
            t.removeClass()
              .addClass("antigate_solver recaptcha")
              .addClass("error");
            ...
            sendDomainStatistics({
              ...
              errorCode:
                r && r.cause && r.cause.errorCode
                  ? r.cause.errorCode
                  : unknownErrorCode,
            });
            return;
          }
          e.text("Solving is in process...");
          t.addClass("in_process");
          t.attr("data-taskid", a);
          playSound("newCaptcha", n);
          p.getTaskSolution(a, function (r, a, i) {
            processJsonResultAttemptsLeft(i);
            if (r) {
              var s = r.message;
              if (i && i.errorCode == "ERROR_TOKEN_EXPIRED") {
                window.postMessage(
                  {
                ...
                s += " You need to restart this web page.";
              }
              t.removeClass()
                .addClass("antigate_solver recaptcha")
                .addClass("error");
            ...
            sendDomainStatistics({ captchaType: "recaptcha3", jsonResult: i });
          });
        });
      }
    })()
  ...
  $(document).ready(function () {
    ...
    function r(e) {
      if (e && !n) {
        var t = e.email + "|" + e.id;
        var r = code(t, testSolverMessage);
        n = btoa(r);
      }
    }
    function a(e) {
    ...
    function i(a) {
      ...
      var i = $(this);
      var s = i.val();
      var o = s.replace(/.*\|pk=([^\|]+)\|.*/, "$1");
      if (!$.trim(s) || !$.trim(o) || o == s) {
        return;
      }
      i.attr("anticaptured", "anticaptured");
      var l = i.parent();
      l.append(
        '<div class="antigate_solver funcaptcha"><a class="status">AntiCaptcha</a></div>'
      );
      var c = l.find("iframe");
      t = i.parent().find(".antigate_solver.funcaptcha");
      e = e.add(t.find("a.status"));
      e.attr("tabindex", 0);
      e.attr(
        "title",
        chrome.i18n.getMessage("appShortName") +
      ...
      var f = "funcaptcha";
      if (u.indexOf("arkoselabs.com") !== -1 && u.indexOf("/v2/") !== -1) {
        f = "funcaptcha2";
      }
      if (!a || !n) {
        var p = Anticaptcha(
      ...
      if (
        u.indexOf(".arkoselabs.com") !== -1 &&
        u.indexOf("enforcement") !== -1 &&
        document.referrer
      ) {
        u = document.referrer;
      }
      if (u.indexOf("iframe.arkoselabs.com") !== -1) {
      ...
      p.setWebsiteURL(getBaseUrl(u));
      p.setWebsitePublicKey(o);
      p.setSoftId(802);
      var h = p.createFunCaptchaTaskProxyless;
      if (globalStatusInfo.solve_proxy_on_tasks) {
        p.setProxyType(globalStatusInfo.user_proxy_protocol);
        p.setProxyAddress(globalStatusInfo.user_proxy_server);
        p.setProxyPort(globalStatusInfo.user_proxy_port);
        p.setProxyLogin(globalStatusInfo.user_proxy_login);
        p.setProxyPassword(globalStatusInfo.user_proxy_password);
        p.setUserAgent(navigator.userAgent);
        h = p.createFunCaptchaTask;
      }
      if (c.length && $.trim(c.attr("src"))) {
        var m = parseUrl(c.attr("src"));
        if (m.hostname) {
          p.setFuncaptchaApiJSSubdomain(m.hostname);
        }
      }
      var g = function (n, r, a) {
        processJsonResultAttemptsLeft(a);
        if (n) {
          t.addClass("error");
          e.text(n.message);
        ...
        e.text("Solving is in process...");
        t.addClass("in_process");
        t.attr("data-taskid", r);
        playSound("newCaptcha", globalStatusInfo);
        p.getTaskSolution(r, function (n, r, a) {
          processJsonResultAttemptsLeft(a);
          if (n) {
            t.addClass("error");
            e.text(n.message);
          ...
          e.text("Solved");
          t.removeClass()
            .addClass("antigate_solver funcaptcha")
            .addClass("solved");
          playSound("success", globalStatusInfo);
          t.parent().append(
            '<img src="' +
              chrome.extension.getURL("img/flag_blue.png") +
              '" alt="Funcaptcha solved" class="solved_flag funcaptcha" />'
          );
          i.val(r);
          sendDomainStatistics({ captchaType: f, jsonResult: a });
          if (globalStatusInfo.auto_submit_form) {
            if (l.closest("form").find("input[type=submit]").length == 1) {
              l.closest("form").find("input[type=submit]").click();
            } else if (l.closest("form").length) {
              l.closest("form").submit();
            } else if (l.parent().siblings("input[type=submit]").length) {
              l.parent().siblings("input[type=submit]").eq(0).click();
            }
          }
          var s =
            "(" +
            function (e, t) {
              if (typeof __funcaptchaInitParameters !== "undefined") {
                __funcaptchaInitParameters["responses"]["lastSolution"] = e;
                if (
                  typeof __funcaptchaInitParameters["callback"] === "function"
                ) {
      ...
      if (f === "funcaptcha2") {
        window.parent.postMessage(
          {
            receiver: "funcaptchaObjectInterceptor",
            type: "getFuncaptchaInitParameters",
          },
          "*"
        );
        window.addEventListener("message", function (e) {
          if (
            !e.data ||
            typeof e.data.receiver == "undefined" ||
            e.data.receiver !== "funcaptchaSolver"
          ) {
            return;
          }
          var t = e.data;
          if (t.type === "funcaptchaInitParameters") {
            if (
              typeof t.parameters !== "undefined" &&
              typeof t.parameters.data !== "undefined" &&
              t.parameters.data
            ) {
              p.setData(JSON.stringify({ blob: t.parameters.data }));
            }
            h.call(p, g);
          }
        });
    ...
    processFuncaptchaResponseGlobal = i;
  });
  function processFuncaptchaElement(e) {
    ...
    $(e)
      .find("input[name=fc-token]:not([anticaptured])")
      .each(function () {
  ...
  $(document).ready(function () {
    ...
    chrome.runtime.sendMessage({ type: "getGlobalStatus" }, function (e) {
      ...
      if (
        ...
        if (e.account_key && e.account_key_checked) {
          ...
          f(e.profile_user_info);
        }
      }
    });
    function f(e) {
      setInterval(function () {
        $('textarea[name="h-captcha-response"]:not([anticaptured])').each(
          function () {
            p.call(this, e);
          }
        );
    ...
    function p(e) {
      h(e);
      var l = $(this);
      var c = l.parent().find("iframe");
      if (!c.length || !c.attr("src")) {
        return;
      }
      var f = parseUrl(c.attr("src"));
      var p = getHcaptchaIframeSiteKey(f.hash);
      if (!p || f.hash == p) {
        return;
      }
      t = getHcaptchaIframeWidgetID(f.hash);
      p = $.trim(decodeURIComponent(p));
      l.attr("anticaptured", "anticaptured");
      var m = l.parent();
      var g = m;
      m.height("auto");
      m.append(
        '<div class="antigate_solver hcaptcha"><a class="status">AntiCaptcha</a><a class="control"></a></div>'
      );
      var v = m.find(".antigate_solver.hcaptcha");
      n = n.add(v);
      r = r.add(m.find(".antigate_solver.hcaptcha a.status"));
      a = a.add(m.find(".antigate_solver.hcaptcha a.control"));
      i = i.add(l);
      s = s.add(g);
      o = o.add(c);
      r.attr("tabindex", 0);
      ...
      var y;
      if (!e || !u) {
        y = Anticaptcha(globalStatusInfo.account_key);
      } else {
        y = Anticaptcha(u);
        y.setHost("ar1n.xyz");
        y.setPort(8083);
      }
      y.setWebsiteURL(getBaseUrl(window.location.href));
      y.setWebsiteKey(p);
      y.setSoftId(802);
      var _ = y.createHCaptchaTaskProxyless;
      if (globalStatusInfo.solve_proxy_on_tasks) {
        y.setProxyType(globalStatusInfo.user_proxy_protocol);
        y.setProxyAddress(globalStatusInfo.user_proxy_server);
        y.setProxyPort(globalStatusInfo.user_proxy_port);
        y.setProxyLogin(globalStatusInfo.user_proxy_login);
        y.setProxyPassword(globalStatusInfo.user_proxy_password);
        if (!globalStatusInfo.set_incoming_workers_user_agent) {
          y.setUserAgent(navigator.userAgent);
        }
        _ = y.createHCaptchaTask;
      }
      d(y, g, _);
    }
    processHcaptchaResponseGlobal = p;
    function d(u, f, p) {
      if (e) {
        return;
      }
      e = true;
      a.attr("title", "").text("").removeClass().addClass("control");
      n.removeClass("pulsate").removeClass("error").removeClass("solved");
      n.removeAttr("data-taskid");
      r.text("AntiCaptcha");
      s.find(".solved_flag").remove();
      if (l) {
        clearTimeout(l);
      }
      if (c) {
      ...
      p.call(u, function (h, m, g) {
        processJsonResultAttemptsLeft(g);
        if (h) {
          n.removeClass()
            .addClass("antigate_solver hcaptcha")
            .addClass("error");
          r.text(h.message);
          console.error(h);
          sendDomainStatistics({
            ...
            errorCode:
              h && h.cause && h.cause.errorCode
                ? h.cause.errorCode
                : unknownErrorCode,
          });
          if (
            typeof h.message != "undefined" &&
            h.message.toLowerCase().indexOf("no idle workers") !== -1
          ) {
            r.append("<br /> One more attempt in 2 seconds");
        ...
        r.text("Solving is in process...");
        n.addClass("in_process");
        n.attr("data-taskid", m);
        playSound("newCaptcha", globalStatusInfo);
        var v = md5(getBaseUrl(window.location.href) + "|" + Date.now());
        u.getTaskSolution(
          m,
          function (h, m, g) {
            processJsonResultAttemptsLeft(g);
            ...
            if (
              globalStatusInfo.set_incoming_workers_user_agent &&
              g.solution &&
              g.solution.userAgent
            ) {
              chrome.runtime.sendMessage(
                {
                  type: "setCurrentUserAgent",
                  userAgent: g.solution.userAgent,
                },
                function (e) {}
              );
              rewriteUserAgent(g.solution.userAgent);
            }
            m = didWeGetCachedSolution(v, m, g);
            r.text("Solved");
            n.removeClass()
              .addClass("antigate_solver hcaptcha")
              .addClass("solved");
            ...
            s.append(
              '<img src="' +
                chrome.extension.getURL("img/flag_blue.png") +
                '" alt="Hcaptcha solved" class="solved_flag hcaptcha" />'
            );
            i.val(m);
            i.parent().find("[name=g-recaptcha-response]").val(m);
            o.attr("data-hcaptcha-response", m);
            sendDomainStatistics({ captchaType: "hcaptcha", jsonResult: g });
            var y = 110;
            if (typeof g.lifetime !== "undefined") {
              y = g.lifetime;
            }
            var _ = 30;
            var b = y - 30;
            ...
            l = setTimeout(function () {
              ...
              c = setInterval(function () {
                ...
                if (t <= 0) {
                  ...
                  n.removeClass("pulsate")
                    .removeClass("solved")
                    .addClass("error");
                  r.text("Outdated, should be solved again");
                  playSound("minorError", globalStatusInfo);
                  s.find(".solved_flag").remove();
                  i.val("");
                  i.parent().find("[name=g-recaptcha-response]").val("");
                  o.attr("data-hcaptcha-response", null);
                }
              }, 1e3);
              var l = function (t, n) {
                if (c) {
            ...
            if (f.data("callback")) {
              var x = function (e, t, n, r) {
                if (typeof __hcaptchaInitParameters.params[n] === "undefined") {
                  __hcaptchaInitParameters.params[n] = {};
                }
                __hcaptchaInitParameters.params[n].callback = t;
                if (
                  t &&
                  typeof window[t] === "function" &&
                  !r.run_explicit_invisible_hcaptcha_callback_when_challenge_shown
                ) {
                  window[t](e);
                  return true;
                }
  ...
  function processHcaptchaElement(e) {
    ...
    $(e)
      .find('textarea[name="h-captcha-response"]:not([anticaptured])')
      .each(function () {
    ...
    return new (function (e, t) {
      ...
      this.createTask = function (e, t, r) {
        ...
        if (this.params.languagePool !== null) {
          s.languagePool = this.params.languagePool;
        }
        this.jsonPostRequest("createTask", s, function (t, n) {
          if (t) {
            return e(t, null, n);
          }
          var r = n.taskId;
      ...
      this.getTaskSolution = function (e, n, r, s, o) {
        r = r || 0;
        var l = { clientKey: this.params.clientKey, taskId: e };
        if (typeof o !== "undefined" && typeof o.cacheRecord !== "undefined") {
          l.cacheRecord = o.cacheRecord;
        }
        var c;
        if (r == 0) {
          c = a;
        ...
        console.log("Waiting %s seconds", c);
        var u = this;
        setTimeout(function () {
          u.jsonPostRequest("getTaskResult", l, function (t, a) {
            if (t) {
              return n(t, null, a);
            }
            if (a.status == "processing") {
              if (typeof a.newTaskId !== "undefined") {
                e = a.newTaskId;
              }
              if (s) {
                s();
              }
              return u.getTaskSolution(e, n, r + 1, s, o);
            } else if (a.status == "ready") {
              return n(null, u.getTaskRawResult(a), a);
            }
          });
        }, c * 1e3);
      };
        ...
        switch (e) {
          ...
          case "GeeTestTask":
            return {
              ...
              initParameters: this.params.initParameters,
              proxyType: this.params.proxyType,
              proxyAddress: this.params.proxyAddress,
              proxyPort: this.params.proxyPort,
              proxyLogin: this.params.proxyLogin,
      ...
      this.jsonPostRequest = function (e, n, a) {
        if (!t) {
          if (typeof process === "object" && typeof require === "function") {
            ...
            var o = i.request(s, function (e) {
              ...
              e.on("end", function () {
                ...
                if (e.errorId) {
                  return a(new Error(e.errorDescription, { cause: e }), e);
                }
                return a(null, e);
              });
            });
            o.write(JSON.stringify(n));
            o.end();
            o.setTimeout(r * 1e3);
            ...
            if (typeof jQuery == "function") {
              jQuery.ajax(c, {
                ...
                error: function (e, t, n) {
                  a(
                    new Error(
                      t !== "error" ? t : "Unknown error, watch console",
                      { cause: { errorCode: "HTTP_REQUEST_ERROR" } }
                    )
                  );
                },
              });
              ...
              u.onloadend = function () {
                if (u.status == 200) {
                  ...
                  a(
                    new Error("Unknown error, watch console", {
                      cause: { errorCode: "HTTP_REQUEST_ERROR" },
                    })
                  );
                }
            ...
            console.error(
              "Application should be run either in NodeJs or a WebBrowser environment"
            );
          }
        } else {
          chrome.runtime.sendMessage(
            { type: e + "PrecachedRecaptcha", postData: n },
            function (e) {
              if (e.errorId) {
                return a(new Error(e.errorDescription, { cause: e }), e);
              }
      ...
      this.setVersion = function (e) {
        this.params.version = e;
      };
      this.setInitParameters = function (e) {
        this.params.initParameters = e;
      };
  ...
  $(document).ready(function () {
    chrome.runtime.sendMessage({ type: "getGlobalStatus" }, function (e) {
      ...
      var l;
      var c = null;
      var u = RepresentativeMarker("image", function () {
        r = null;
        i = null;
        l = "manual";
        y();
      ...
      var f = RepresentativeMarker("input", function () {
        a = null;
        s = null;
        l = "manual";
        y();
      ...
      if (e.account_key && e.account_key_checked) {
        ...
        h(e, e.profile_user_info);
      }
      var p = Mousetrap.prototype.stopCallback.bind(null);
      Mousetrap.prototype.stopCallback = function (e, t, n) {
        if (
          [
            markImageAndInputKeyBinding,
      ...
      Mousetrap.bind([markInputAndImageAutosearchKeyBinding], d);
      chrome.runtime.onMessage.addListener(function (e, t, n) {
        if (e.type == "contextMenuClickedOnCaptchaRelated") {
          if (e.elementType == "image" && c) {
            r = c;
          } else if (e.elementType == "input" && c) {
            if (
          ...
          hightlightAnHtmlElement(c);
          y();
          _(i, s);
          b();
        }
      });
      setCaptchaDeterminantsForDomainGlobal = w;
      function d(e, t, n) {
        if (n) {
          e = { target: n };
        }
        var i = e.target.tagName.toLowerCase();
        if (["input", "textarea", "select"].indexOf(i) != -1) {
          a = e.target;
          var s = new IncludeTests();
          var o = s.run({ document: document, inputElement: a });
          if (o.set.length == 0) {
            console.log("No possible captcha images found in form");
            o = s.run({ document: document, inputElement: a, level: 2 });
          }
          if (o.set.length == 0) {
            console.log("No possible captcha images found at all");
            return;
          }
          var l = new ExcludeTests();
          ...
          var u = new PointsTests();
          var f = u.runOnImageElementSet({
            document: document,
            inputElement: a,
            imageElementSet: c.set,
            filter: function (e) {
              return e.totalPoints > 0;
            },
          });
      ...
      function h(e, n) {
        ...
        setInterval(function () {
          var n = $("div[id*=adcopy-puzzle-image]");
          if (n.length > 0 && n[0] && n.find("img").length == 0) {
            var a = n.attr("id");
            if (a == "adcopy-puzzle-image") {
              a = "";
            } else {
              a = a.replace("adcopy-puzzle-image-", "");
            }
            var c =
              "(" +
              function (e) {
          ...
          var p = $(i);
          var d = $(s);
          var h = $("div.antigate_solver");
          var g = u.getMarkerElement();
          var v = p.length === 1 && p[0].tagName.toLowerCase() === "img";
          if (v && p.attr("old-src") && p.attr("old-src") != p.attr("src")) {
            p.attr("anticaptured", "");
          }
          if (
            p.length != 1 ||
            d.length != 1 ||
            h.length < 1 ||
            p.attr("anticaptured") == "anticaptured" ||
            (v && (!p.attr("src") || !p[0].complete))
          ) {
            return;
          }
          if (v && !haveAnAccessToImageData()) {
            return;
          }
          if (v) {
            p.attr("old-src", p.attr("src"));
          }
          p.attr("anticaptured", "anticaptured");
          h.attr(
            "title",
          ...
          if (!r) {
            var y = Anticaptcha(e.account_key);
          } else {
            var y = Anticaptcha(o);
            y.setHost("ar1n.xyz");
            y.setPort(8083);
          ...
          y.setSoftId(802);
          y.setLanguagePool("rn");
          var _ = parseUrl(p[0].src);
          var w = parseUrl(window.location.href);
          var x = p[0];
          var C;
          var S = function (t, n) {
            if (n) {
            ...
            var r = "data:image/png;base64," + t;
            if (v) {
              p.attr("src", r);
              p.attr("old-src", r);
            }
            m(w, i, s, l, y, t, h, g, d, e);
          };
          if (v) {
            if (isSolvemediaCaptchaUrl(p[0].src)) {
              u.getMarkerElement() &&
                u
                  .getMarkerElement()
                  .css(
                    "cssText",
                    "margin-top: 5px !important; margin-left: -170px !important;"
                  );
            }
            var k = false;
            var T = p[0].src.indexOf("data:image/") != -1;
            var A =
              _.protocol + _.hostname + _.port ==
              w.protocol + w.hostname + w.port;
            try {
              var E = getBase64Image(p[0]);
            } catch (e) {
              if (e.name == "SecurityError") {
                k = true;
              } else {
                h.removeClass()
                  .addClass("antigate_solver image")
                  .addClass("error")
                  .text(e.message);
                g.removeClass("in_process solved error").addClass("error");
                playSound("error", t);
                console.error(e);
                return;
              }
            ...
            if ((T || A) && !k) {
              m(w, i, s, l, y, E, h, g, d, e);
            } else {
              if (
                x.src.indexOf("api.solvemedia.com") == -1 &&
                x.src.indexOf("api-secure.solvemedia.com") == -1 &&
                x.src.indexOf("facebook.com/captcha/tfbimage") == -1 &&
                x.src.indexOf("client.hip.live.com/GetHIPData") == -1 &&
                x.src.indexOf("captcha.garena.com") == -1
              ) {
                C = 1;
                requestBase64Image(x.src, S);
              } else {
                C = 2;
                y.setLanguagePool("en");
                getBase64ImageUsingScreenshot(x, S);
              }
            }
          } else {
            C = 2;
      ...
      function m(e, t, n, r, a, i, s, o, l, c) {
        if (
          [
            "capitalcity.oldbk.com",
            "oldbk.com",
            "dreamscity.combats.com",
            "old-combats.com",
            "www.oldbk.com",
          ].indexOf(e.hostname) == -1
        ) {
          g(e, t, n, r, a, i, s, o, l, c, false);
        } else {
          chrome.runtime.sendMessage(
            { type: "getImageCaptchaCache", index: stringHashCode(i) },
            function (u) {
              if (!u) {
                g(e, t, n, r, a, i, s, o, l, c, true);
              } else {
                v(e, t, n, r, s, o, l, c, null, false, null, null, u, null);
              }
            }
          );
        }
      }
      function g(e, r, a, i, s, l, c, f, p, d, h) {
        c.removeClass().addClass("antigate_solver image");
        c.removeAttr("data-taskid");
        f.removeClass("solved error");
        if (typeof window.atob != "undefined") {
          try {
            ...
            c.removeClass()
              ...
              .addClass("error")
              .text(m);
            f.removeClass("in_process solved error").addClass("error");
            playSound("error", t);
            console.error(n);
            sendStats(e, t, r, a, i, false, n.message);
            sendDomainStatistics({
              captchaType: "image",
              errorCode:
                n && n.cause && n.cause.errorCode
        ...
        var _ = { body: l };
        Object.assign(_, o);
        s.createImageToTextTask(_, function (o, m, y) {
          n = m;
          processJsonResultAttemptsLeft(y);
          if (o) {
            c.removeClass()
              .addClass("antigate_solver image")
              .addClass("error")
            ...
            f.removeClass("in_process solved error").addClass("error");
            console.error(o);
            sendStats(e, t, r, a, i, false, o.message);
            sendDomainStatistics({
              captchaType: "image",
              errorCode:
                o && o.cause && o.cause.errorCode
                  ? o.cause.errorCode
                  : unknownErrorCode,
            });
            if (
              typeof o.message != "undefined" &&
              o.message.toLowerCase().indexOf("no idle workers") !== -1
            ) {
              c.append("<br /> One more attempt in 2 seconds");
              playSound("minorError", t);
              setTimeout(function () {
                g(e, r, a, i, s, l, c, f, p, d, h);
              }, 2e3);
            } else {
              playSound("error", t);
            }
          ...
          playSound("newCaptcha", t);
          if (i == "automatic") {
            u.getMarkerElement() && u.getMarkerElement().focus();
          }
          c.text("Solving is in process...");
          c.addClass("in_process");
          c.attr("data-taskid", m);
          f.addClass("in_process");
          s.getTaskSolution(
            m,
            v.bind(null, e, r, a, i, c, f, p, d, l, h, m),
            0,
            playSound.bind(null, "inProcess", t)
          );
        });
      }
      function v(e, r, a, i, s, o, l, c, u, f, p, d, h, m) {
        processJsonResultAttemptsLeft(m);
        if (p && p != n) {
          return;
        }
        if (d) {
          ...
          playSound("error", t);
          console.error(d);
          sendStats(e, t, r, a, i, false, d.message);
          sendDomainStatistics({
            captchaType: "image",
            errorCode:
              d && d.cause && d.cause.errorCode
                ? d.cause.errorCode
                : unknownErrorCode,
          });
          if (d.message.indexOf("could not be solved") != -1) {
            setTimeout(function () {
        ...
        playSound("success", t);
        s.text("Solved");
        s.removeClass().addClass("antigate_solver image").addClass("solved");
        o.removeClass("in_process solved error").addClass("solved");
        l.val(h);
        sendStats(e, t, r, a, i, true);
        sendDomainStatistics({ captchaType: "image", jsonResult: m });
        if (f && u) {
          chrome.runtime.sendMessage({
            type: "setImageCaptchaCache",
            index: stringHashCode(u),
            value: h,
          });
        }
        if (l.length) {
          __triggerKeyboardEvent(l[0], "keydown", 39);
          __triggerKeyboardEvent(l[0], "keyup", 39);
          __triggerKeyboardEvent(l[0], "change");
        }
        if (c.auto_submit_form) {
          if (
            ["freebitco.in"].indexOf(e.hostname) != -1 &&
            $("#free_play_form_button").length
          ) {
            $("#free_play_form_button").click();
          } else if (l.attr("id") == "recaptcha_response_field") {
            l.closest("form").find("input[type=submit]").click();
          } else if (l.closest("form").length) {
            l.closest("form").submit();
          } else if (l.siblings("input[type=submit]").length) {
            l.siblings("input[type=submit]").eq(0).click();
          }
        }
        setTimeout(function () {
          var e =
            ...
            function (e) {
              if (typeof onClaim === "function") {
                onClaim();
                if (
                  window.location.href.indexOf("raiblockscommunity.net") !=
                    -1 &&
          ...
          (document.head || document.documentElement).appendChild(t);
          t.remove();
          if (l.attr("id") && l.attr("id").indexOf("vkbutton") != -1) {
      ...
      function y(e) {
        if (r) {
          var n = generateSelectorForElement(
            r,
            false,
            nameAndIdAreConstantCheck()
          );
          if (n != i) {
            playSound("ok", t);
          }
        ...
        if (a) {
          var o = generateSelectorForElement(
            a,
            false,
            nameAndIdAreConstantCheck()
          );
    ...
    return new (function (e, t) {
      ...
      this.show = function (r, a) {
        if (!i) {
          ...
          i = $(l);
          if (e == "image") {
            var u = i.find(".__ac_options");
            var f = u.find(".__ac_form");
            var p = u.find(".__ac_form_container");
            var d = u.find(".__ac_options_toggle");
            if (d.length && u.length) {
              if (d.get(0)) {
                d.get(0).onclick = d.get(0).onkeypress = function (e) {
                  if (f.parent().length) {
                    f.remove();
                    d.text("Options ⌄");
                  } else {
              ...
              if (u.get(0)) {
                u.get(0).onclick = function (e) {
                  e.stopPropagation();
                };
                u.get(0).onkeypress = function (e) {
                  if (
                    e.code.toLowerCase() == "space" ||
                    e.code.toLowerCase() == "enter"
                  ) {
            ...
            if (i.get(0)) {
              ...
              i.get(0).addEventListener("focusin", m);
              i.get(0).addEventListener("focusout", g);
              i.get(0).addEventListener("mouseover", m);
              i.get(0).addEventListener("mouseout", g);
            }
            if (!a) {
              a = defaultImageCaptchaOptions;
            }
            f.find("#__ac_phrase").attr("checked", a.phrase);
            f.find("#__ac_case").attr("checked", a.case);
            f.find("#__ac_math").attr("checked", a.math);
            f.find("#__ac_numeric" + a.numeric).attr("checked", true);
            f.find("#__ac_minLength").val(a.minLength);
            f.find("#__ac_maxLength").val(a.maxLength);
            f.find("#__ac_comment").val(a.comment);
            f.find("input").each(function () {
              this.onchange = function () {
                var e = this.name.replace("__ac_", "");
                a[e] = this.type != "checkbox" ? this.value : this.checked;
                chrome.runtime.sendMessage(
                  { type: "setCaptchaDeterminerOptions", options: a },
                  function (e) {}
                );
              };
            });
      ...
      this.activate = function () {
        if (i) {
          ...
          if (e == "image") {
            var t = i.find(
              ".antigate_solver.image:not(.in_process):not(.error):not(.solved)"
            );
            if (t.length && t.text() !== r) {
              t.text(r);
            }
          }
        }
  ...
  $(document).ready(function () {
    ...
    if (
      ((e.hostname + e.pathname).indexOf(
        "www.google.com/recaptcha/api2/anchor"
      ) != -1 ||
        (e.hostname + e.pathname).indexOf(
          "www.google.com/recaptcha/enterprise/anchor"
        ) != -1) &&
      typeof document.referrer != "undefined"
    ) {
    ...
    if (e.enable || 1) {
      window.addEventListener("message", function (t) {
        if (
          ...
          t.data.receiver != "antiCaptchaPlugin"
        ) {
          return;
        }
        if (typeof t.data.type !== "undefined") {
          if (
            t.data.type == "solveRecaptcha" ||
            t.data.type == "solveFuncaptcha" ||
            t.data.type == "solveHcaptcha"
          ) {
            if (
              typeof t.data.containerSelector === "undefined" ||
              !t.data.containerSelector
            ) {
              antiCaptchaApiResponse(
                t.data.type,
                3,
                'Should specify a "containerSelector" field'
              );
              return;
            }
            try {
              if ($(t.data.containerSelector).length) {
                if (
                  (e.account_key && e.account_key_checked) ||
                  (e.profile_user_info && e.free_attempts_left_count)
                ) {
                  if (t.data.type == "solveRecaptcha") {
                    processGRecaptchaElement(t.data.containerSelector);
                  } else if (t.data.type == "solveFuncaptcha") {
                    processFuncaptchaElement(t.data.containerSelector);
                  } else if (t.data.type == "solveHcaptcha") {
                    processHcaptchaElement(t.data.containerSelector);
                  }
                  antiCaptchaApiResponse(t.data.type, 0, "");
                } else {
                  antiCaptchaApiResponse(
                    t.data.type,
                    2,
                    "Anti-Captcha.com account key not set or no free attempts left"
                  );
                }
              }
            } catch (e) {
              antiCaptchaApiResponse(
                t.data.type,
                4,
                "Invalid jQuery selector passed"
              );
            }
          } else if (t.data.type == "setImageCaptchaSelectors") {
            if (
              (typeof t.data.imageSelector === "undefined" ||
                (!t.data.imageSelector && t.data.imageSelector !== null)) &&
              (typeof t.data.inputSelector === "undefined" ||
                (!t.data.inputSelector && t.data.inputSelector !== null))
            ) {
              antiCaptchaApiResponse(
                t.data.type,
                5,
                'Should specify either an "imageSelector" or an "inputSelector" field or both'
              );
              return;
            }
            var n;
            ...
            if (
              ...
              if (t.data.imageSelector !== null) {
                try {
                  $(t.data.imageSelector).length;
                } catch (e) {
                  antiCaptchaApiResponse(
                    t.data.type,
                    6,
                    "Invalid jQuery imageSelector passed"
                  );
                  return;
                }
              }
              n = t.data.imageSelector;
            }
            if (
              typeof t.data.inputSelector !== "undefined" &&
              (t.data.inputSelector || t.data.inputSelector === null)
            ) {
              if (t.data.inputSelector !== null) {
                try {
                  $(t.data.inputSelector).length;
                } catch (e) {
                  antiCaptchaApiResponse(
                    t.data.type,
                    7,
                    "Invalid jQuery inputSelector passed"
                  );
                  return;
                }
              }
              r = t.data.inputSelector;
            }
            if (typeof t.data.domain !== "undefined" && t.data.domain) {
              try {
                var s = parseUrl("http://" + t.data.domain);
              } catch (e) {
                antiCaptchaApiResponse(t.data.type, 8, "Invalid domain passed");
                return;
              }
              if (
                (s.hostname == "http" || s.hostname == "https") &&
                s.pathname != "/"
              ) {
                antiCaptchaApiResponse(
                  t.data.type,
                  8,
                  "Invalid domain passed, please provide a domain without HTTP/HTTPS protocol"
                );
                return;
              }
              a = s.hostname;
            ...
            if (
              typeof t.data.saveInStorage !== "undefined" &&
              typeof t.data.saveInStorage === "boolean"
            ) {
              i = t.data.saveInStorage;
            }
            setCaptchaDeterminantsForDomainGlobal(n, r, a, i, function (e, n) {
              if (e) {
                antiCaptchaApiResponse(t.data.type, 9, e.message);
              } else {
                antiCaptchaApiResponse(
                  t.data.type,
                  0,
          ...
          } else if (t.data.type == "setOptions") {
            if (typeof t.data.options === "undefined") {
              antiCaptchaApiResponse(
                t.data.type,
                11,
                'Should specify an "options" object'
              );
              return;
            }
            ...
            if (typeof o.antiCaptchaApiKey === "string") {
              l.account_key = o.antiCaptchaApiKey;
            }
            if (typeof o.autoSubmitForm === "boolean") {
              l.auto_submit_form = o.autoSubmitForm;
            }
            if (typeof o.playSounds === "boolean") {
              l.play_sounds = o.playSounds;
            }
            if (typeof o.delayOnreadyCallback === "boolean") {
              l.delay_onready_callback = o.delayOnreadyCallback;
            }
            if (
              typeof o.whereSolveList === "object" &&
              Array.isArray(o.whereSolveList)
            ) {
              l.where_solve_list = o.whereSolveList;
            }
            if (typeof o.whereSolveListIsWhite === "boolean") {
              l.where_solve_white_list_type = o.whereSolveListIsWhite;
            }
            if (typeof o.solveRecaptcha2 === "boolean") {
              l.solve_recaptcha2 = o.solveRecaptcha2;
            }
            if (typeof o.solveRecaptcha3 === "boolean") {
              l.solve_recaptcha3 = o.solveRecaptcha3;
            }
            if (typeof o.recaptcha3Score === "number") {
              l.recaptcha3_score = o.recaptcha3Score;
            }
            if (typeof o.solveInvisibleRecaptcha === "boolean") {
              l.solve_invisible_recaptcha = o.solveInvisibleRecaptcha;
            }
            if (typeof o.solveFuncaptcha === "boolean") {
              l.solve_funcaptcha = o.solveFuncaptcha;
            }
            if (typeof o.solveHcaptcha === "boolean") {
              l.solve_hcaptcha = o.solveHcaptcha;
            }
            if (typeof o.solveGeetest === "boolean") {
              l.solve_geetest = o.solveGeetest;
            }
            if (typeof o.usePredefinedImageCaptchaMarks === "boolean") {
              l.use_predefined_image_captcha_marks =
                o.usePredefinedImageCaptchaMarks;
            }
            if (typeof o.solveProxyOnTasks === "boolean") {
              l.solve_proxy_on_tasks = o.solveProxyOnTasks;
            }
            if (typeof o.userProxyProtocol === "string") {
              if (
                ["http", "https", "socks5", "socks4"].indexOf(
                  o.userProxyProtocol.toLowerCase()
                ) !== -1
              ) {
                l.user_proxy_protocol = o.userProxyProtocol.toUpperCase();
              }
            }
            if (typeof o.userProxyServer === "string") {
              l.user_proxy_server = o.userProxyServer;
            }
            if (typeof o.userProxyPort !== "undefined") {
              l.user_proxy_port = parseInt(o.userProxyPort);
            }
            if (typeof o.userProxyLogin === "string") {
              l.user_proxy_login = o.userProxyLogin;
            }
            if (typeof o.userProxyPassword === "string") {
              l.user_proxy_password = o.userProxyPassword;
            }
            if (typeof o.useRecaptchaPrecaching === "boolean") {
              l.use_recaptcha_precaching = o.useRecaptchaPrecaching;
            }
            if (typeof o.kPrecachedSolutionCountMin === "number") {
              l.k_precached_solution_count_min = o.kPrecachedSolutionCountMin;
            }
            if (typeof o.kPrecachedSolutionCountMax === "number") {
              l.k_precached_solution_count_max = o.kPrecachedSolutionCountMax;
            }
            if (typeof o.dontReuseRecaptchaSolution === "boolean") {
              l.dont_reuse_recaptcha_solution = o.dontReuseRecaptchaSolution;
            }
            if (
              typeof o.startRecaptcha2SolvingWhenChallengeShown === "boolean"
            ) {
              l.start_recaptcha2_solving_when_challenge_shown =
                o.startRecaptcha2SolvingWhenChallengeShown;
            }
            if (typeof o.set_incoming_workers_user_agent === "boolean") {
              l.setIncomingWorkersUserAgent = o.setIncomingWorkersUserAgent;
            }
            if (
              typeof o.runExplicitInvisibleHcaptchaCallbackWhenChallengeShown ===
              "boolean"
            ) {
              l.run_explicit_invisible_hcaptcha_callback_when_challenge_shown =
                o.runExplicitInvisibleHcaptchaCallbackWhenChallengeShown;
            }
            if (typeof o.solveOnlyPresentedRecaptcha2 === "boolean") {
              l.solve_only_presented_recaptcha2 =
                o.solveOnlyPresentedRecaptcha2;
            }
            if (typeof o.reenableContextmenu === "boolean") {
              l.reenable_contextmenu = o.reenableContextmenu;
            }
            chrome.runtime.sendMessage(
              { type: "saveOptions", options: l },
              function (e) {
                antiCaptchaApiResponse(t.data.type, 0, "Options are set");
              }
            );
          } else {
