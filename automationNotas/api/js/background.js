...
(function () {
  ...
  function b(e) {
    if (
      ...
      if (D() - currentUserAgentByTabId[e].createdAt <= o) {
  ...
  function w(e) {
    if (window.navigator.userAgent !== e) {
      ...
      var i = function (e, t, n, r) {
        ...
        try {
          Object.defineProperty(window.navigator, "userAgent", i);
        } catch (e) {
          window.navigator = Object.create(navigator, { userAgent: i });
        }
        if (t) {
  ...
  function F({ siteKey: e, stoken: t, isEnterprise: n }) {
    var r = {
      anticaptcha: null,
      siteKey: e,
      representatives: [],
  ...
  function z(e, t, n) {
    ...
    var i;
    if (r.left < 0 || r.top < 0 || r.right >= X() || r.bottom >= J()) {
      i = true;
      var a = {
        display: "block",
        position: "fixed",
    ...
    for (var o in a) {
      ...
      e.style.setProperty(o, a[o], "important");
    }
    if (i) {
    ...
    setTimeout(function () {
      chrome.runtime.sendMessage({ type: "captureScreen" }, function (n) {
        for (var a in s) {
          e.style.setProperty(a, s[a].value, s[a].priority);
        }
        if (i) {
          if (u.nextSibling) {
    ...
    for (var o = 0; o < r.length; o++) {
      s =
        ...
        $.trim(r[o].getAttribute("name")).length < 48
          ? '[name="' + Y($.trim(r[o].getAttribute("name"))) + '"]'
          : "") +
  ...
  function ye() {
    ...
    y.extend = y.fn.extend = function () {
      ...
      if (typeof s !== "object" && !y.isFunction(s)) {
        s = {};
      }
      if (o === u) {
        s = this;
    ...
    var k =
      ...
      (function (e) {
        ...
        try {
          N.apply((E = D.call(x.childNodes)), x.childNodes);
            ...
            if (m) {
              if (T !== 11 && (f = Q.exec(e))) {
                if ((a = f[1])) {
                  ...
                  N.apply(r, t.getElementsByTagName(e));
                  return r;
                } else if (
                  (a = f[3]) &&
                  ...
                  N.apply(r, t.getElementsByClassName(a));
                  return r;
                }
              }
              if (n.qsa && !C[e + " "] && (!g || !g.test(e))) {
                ...
                if (y) {
                  try {
                    N.apply(r, v.querySelectorAll(y));
                    return r;
                  } catch (e) {
                  } finally {
                    if (c === w) {
        ...
        s = ae.tokenize = function (e, t) {
          ...
          return t ? o.length : o ? ae.error(e) : A(e, u).slice(0);
        };
        function ye(e) {
          var t = 0,
            n = e.length,
        ...
        function Te(e, t, n, r, i, a) {
          ...
          return oe(function (a, s, o, u) {
            var l,
              ...
              p = [],
              h = s.length,
              m = a || we(t || "*", o.nodeType ? [o] : o, []),
              g = e && (a || !t) ? xe(m, d, e, o, u) : m,
              y = n ? (i || (a ? e : h || r) ? [] : s) : g;
            if (n) {
              n(g, y, o, u);
            }
          ...
          var n = t.length > 0,
            ...
            a = function (a, s, o, u, c) {
              var f,
                ...
                x = l,
                k = a || (i && r.find["TAG"]("*", c)),
                S = (T += x == null ? 1 : Math.random() || 0.1),
                A = k.length;
              if (c) {
                l = s === p || s || c;
              }
              for (; v !== A && (f = k[v]) != null; v++) {
                if (i && f) {
                  h = 0;
                  if (!s && f.ownerDocument !== p) {
                    d(f);
                    o = !m;
                  }
                  while ((g = e[h++])) {
              ...
              if ((f = r.find[c])) {
                if (
                  (i = f(
                    ...
                    (Y.test(u[0].type) && me(t.parentNode)) || t
                  ))
                ) {
                  u.splice(a, 1);
                  e = i.length && ye(u);
    ...
    var C = y.expr.match.needsContext;
    var _ = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
    var L = /^.[^:#\[\.,]*$/;
    function E(e, t, n) {
      if (y.isFunction(t)) {
    ...
    y.fn.extend({
      ...
      is: function (e) {
        return !!E(
          this,
          typeof e === "string" && C.test(e) ? y(e) : e || [],
          false
        ).length;
      },
    });
    ...
    var D = /^(?:parents|prev(?:Until|All))/,
      R = { children: true, contents: true, next: true, prev: true };
    y.fn.extend({
      has: function (e) {
        var t = y(e, this),
          n = t.length;
          ...
          for (; r < i; r++) {
            for (n = this[r]; n && n !== t; n = n.parentNode) {
              if (
                ...
                (s
                  ? s.index(n) > -1
                  : n.nodeType === 1 && y.find.matchesSelector(n, e))
              ) {
                a.push(n);
                break;
              }
    ...
    y.extend({
        ...
        var n = [
          ...
          i = {
            ...
            then: function (t, r, i) {
              ...
              return y
                .Deferred(function (e) {
                  n[0][3].add(s(0, e, y.isFunction(i) ? i : q, e.notifyWith));
                  n[1][3].add(s(0, e, y.isFunction(t) ? t : q));
                  n[2][3].add(s(0, e, y.isFunction(r) ? r : O));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (t <= 1) {
          F(e, s.done(o(n)).resolve, s.reject);
          if (s.state() === "pending" || y.isFunction(i[n] && i[n].then)) {
            return s.then();
          }
        }
        while (n--) {
    ...
    $.prototype = {
      ...
      get: function (e, t) {
        return t === undefined
          ? this.cache(e)
          : e[this.expando] && e[this.expando][y.camelCase(t)];
      },
    ...
    var ne = function (e, t) {
      ...
      return (
        ...
        (e.style.display === "" &&
          y.contains(e.ownerDocument, e) &&
          y.css(e, "display") === "none")
      );
    };
      ...
      for (; p < h; p++) {
        ...
        if (a || a === 0) {
          if (y.type(a) === "object") {
            ...
            u = fe[o] || fe._default;
            s.innerHTML = u[1] + y.htmlPrefilter(a) + u[2];
            c = u[0];
            while (c--) {
              s = s.lastChild;
            }
            y.merge(d, s.childNodes);
            s = f.firstChild;
            s.textContent = "";
          }
        }
    ...
    y.event = {
      ...
      add: function (e, t, n, r, i) {
        ...
        if (!(s = g.handle)) {
          s = g.handle = function (t) {
            return typeof y !== "undefined" && y.event.triggered !== t.type
              ? y.event.dispatch.apply(e, arguments)
              : undefined;
          };
        }
        t = (t || "").match(M) || [""];
      ...
      remove: function (e, t, n, r, i) {
        ...
        while (l--) {
          ...
          if (!p) {
            for (p in u) {
              y.event.remove(e, p + t[l], n, r, true);
            }
            continue;
          }
          f = y.event.special[p] || {};
      ...
      dispatch: function (e) {
        ...
        o = y.event.handlers.call(this, t, l);
        n = 0;
        while ((a = o[n++]) && !t.isPropagationStopped()) {
          ...
          while ((s = a.handlers[r++]) && !t.isImmediatePropagationStopped()) {
            if (!t.rnamespace || t.rnamespace.test(s.namespace)) {
              ...
              t.data = s.data;
              i = (
                (y.event.special[s.origType] || {}).handle || s.handler
              ).apply(a.elem, u);
              if (i !== undefined) {
                if ((t.result = i) === false) {
                  t.preventDefault();
      ...
      handlers: function (e, t) {
        ...
        l = this;
        if (u < t.length) {
          o.push({ elem: l, handlers: t.slice(u) });
        }
        return o;
      },
    ...
    function Ee(e, t) {
      if (
        y.nodeName(e, "table") &&
        y.nodeName(t.nodeType !== 11 ? t : t.firstChild, "tr")
      ) {
    ...
    function Re(e, t, n, r) {
      ...
      if (
        v ||
        (d > 1 && typeof g === "string" && !h.checkClone && Ce.test(g))
      ) {
    ...
    function Oe(e, t, n) {
      ...
      if (n) {
        ...
        if (s === "" && !y.contains(e.ownerDocument, e)) {
          s = y.style(e, t);
        }
        if (!h.pixelMarginRight() && He.test(s) && Me.test(t)) {
          r = o.width;
          i = o.minWidth;
          a = o.maxWidth;
    ...
    function ze(e, t, n, r, i) {
      ...
      for (; a < 4; a += 2) {
        if (n === "margin") {
          s += y.css(e, n + te[a], true, i);
        }
        if (r) {
          if (n === "content") {
            s -= y.css(e, "padding" + te[a], true, i);
          }
          if (n !== "margin") {
            s -= y.css(e, "border" + te[a] + "Width", true, i);
          }
        } else {
          s += y.css(e, "padding" + te[a], true, i);
          if (n !== "padding") {
    ...
    function Xe(e, t, n) {
      var r,
        i = true,
        a = qe(e),
        s = y.css(e, "boxSizing", false, a) === "border-box";
    ...
    y.extend({
      ...
      style: function (e, t, n, r) {
        ...
        var i,
          ...
          o = y.camelCase(t),
          u = e.style;
        t = y.cssProps[o] || (y.cssProps[o] = $e(o) || o);
        s = y.cssHooks[t] || y.cssHooks[o];
        if (n !== undefined) {
          a = typeof n;
    ...
    y.each(["height", "width"], function (e, t) {
      y.cssHooks[t] = {
        get: function (e, n, r) {
          if (n) {
            return Be.test(y.css(e, "display")) &&
        ...
        set: function (e, n, r) {
          var i,
            ...
            s =
              r &&
              ze(e, t, r, y.css(e, "boxSizing", false, a) === "border-box", a);
          if (s && (i = ee.exec(n)) && (i[3] || "px") !== "px") {
            e.style[t] = n;
            n = y.css(e, t);
          }
          return Ge(e, n, s);
    ...
    Je.prototype = {
      ...
      run: function (e) {
        ...
        if (this.options.duration) {
          this.pos = t = y.easing[this.easing](
            e,
      ...
      _default: {
        ...
        set: function (e) {
          if (y.fx.step[e.prop]) {
            ...
            e.elem.nodeType === 1 &&
            (e.elem.style[y.cssProps[e.prop]] != null || y.cssHooks[e.prop])
          ) {
    ...
    function at(e, t, n) {
      ...
      for (r in t) {
        ...
        if (Ze.test(i)) {
          ...
          p[r] = (g && g[r]) || y.style(e, r);
        }
      }
      u = !y.isEmptyObject(t);
      if (!u && y.isEmptyObject(p)) {
        return;
      }
      if (f && e.nodeType === 1) {
    ...
    function ot(e, t, n) {
      ...
      for (; a < s; a++) {
        r = ot.prefilters[a].call(l, e, c, l.opts);
        if (r) {
    ...
    y.fx.start = function () {
      if (!Ye) {
        Ye = e.requestAnimationFrame
          ? e.requestAnimationFrame(tt)
          : e.setInterval(y.fx.tick, y.fx.interval);
      }
    };
    y.fx.stop = function () {
    ...
    y.extend({
      attr: function (e, t, n) {
        ...
        if (a !== 1 || !y.isXMLDoc(e)) {
          i =
            y.attrHooks[t.toLowerCase()] ||
            (y.expr.match.bool.test(t) ? ut : undefined);
        }
        if (n !== undefined) {
          if (n === null) {
            y.removeAttr(e, t);
        ...
        return this.each(function () {
          ...
          if (n === "string") {
            ...
            if (this.setAttribute) {
              this.setAttribute(
                "class",
                t || e === false ? "" : G.get(this, "__className__") || ""
              );
            }
          }
        });
            ...
            for (; r < u; r++) {
              ...
              if (
                ...
                (!n.parentNode.disabled ||
                  !y.nodeName(n.parentNode, "optgroup"))
              ) {
                t = y(n).val();
                if (s) {
                  return t;
    ...
    y.extend(y.event, {
      trigger: function (t, n, i, a) {
        ...
        p = y.event.special[m] || {};
        if (!a && p.trigger && p.trigger.apply(i, n) === false) {
          return;
        }
        if (!a && !p.noBubble && !y.isWindow(i)) {
          l = p.delegateType || m;
          if (!mt.test(l + m)) {
            o = o.parentNode;
          }
        ...
        while ((o = h[s++]) && !t.isPropagationStopped()) {
          t.type = s > 1 ? l : p.bindType || m;
          d = (G.get(o, "events") || {})[t.type] && G.get(o, "handle");
          if (d) {
            d.apply(o, n);
          }
          d = c && o[c];
        ...
        if (!a && !t.isDefaultPrevented()) {
          if ((!p._default || p._default.apply(h.pop(), n) === false) && V(i)) {
    ...
    y.extend({
      ...
      ajax: function (t, n) {
        ...
        function A(t, n, r, o) {
          ...
          S.statusText = (n || k) + "";
          if (l) {
            v.resolveWith(m, [d, k, S]);
          } else {
            v.rejectWith(m, [S, k, p]);
          }
          S.statusCode(w);
          w = undefined;
          if (f) {
            g.trigger(l ? "ajaxSuccess" : "ajaxError", [S, h, l ? d : p]);
          }
          b.fireWith(m, [S, k]);
          if (f) {
    ...
    y.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      if (o || t.dataTypes[0] === "jsonp") {
        i = t.jsonpCallback = y.isFunction(t.jsonpCallback)
          ? t.jsonpCallback()
          : t.jsonpCallback;
        if (o) {
          t[o] = t[o].replace(Wt, "$1" + i);
    ...
    y.fn.load = function (e, t, n) {
      ...
      if (s.length > 0) {
        y.ajax({ url: e, type: i || "GET", dataType: "html", data: t })
          .done(function (e) {
            a = arguments;
        ...
        function (n, r) {
          y.fn[r] = function (i, a) {
            var s = arguments.length && (n || typeof i !== "boolean"),
              o = n || (i === true || a === true ? "margin" : "border");
            return K(
              this,
              function (t, n, i) {
                var a;
                ...
                return i === undefined ? y.css(t, n, o) : y.style(t, n, i, o);
              },
              t,
              s ? i : undefined,
              s
  ...
  chrome.webRequest.onHeadersReceived.addListener(
    function (e) {
      for (var t = 0; t < e.responseHeaders.length; ++t) {
        if (
          e.responseHeaders[t].name.toLowerCase() === "content-security-policy"
        ) {
      ...
      for (var t = 0; t < e.responseHeaders.length; ++t) {
        if (
          e.responseHeaders[t].name.toLowerCase() ===
  ...
  chrome.webRequest.onHeadersReceived.addListener(
    function (e) {
      if (
        typeof globalStatus === "undefined" ||
        !globalStatus.enable ||
        typeof globalStatus.solve_funcaptcha === "undefined" ||
        !globalStatus.solve_funcaptcha ||
        (typeof e.initiator !== "undefined" &&
          currentHostnameWhiteBlackListedOut(globalStatus, e.initiator))
      ) {
        return;
      }
      if (e.url.endsWith("/sri/") || e.type !== "script") {
        return;
      }
    ...
    {
      urls: [
        "https://funcaptcha.com/fc/api/*",
        "https://*.funcaptcha.com/fc/api/*",
        "https://arkoselabs.com/fc/api/*",
        "https://*.arkoselabs.com/fc/api/*",
        "https://arkoselabs.com/v2/*/api.js*",
        "https://*.arkoselabs.com/v2/*/api.js*",
      ],
    }
  );
  chrome.webRequest.onHeadersReceived.addListener(
    function (e) {
      if (
        typeof globalStatus === "undefined" ||
        !globalStatus.enable ||
        typeof globalStatus.solve_hcaptcha === "undefined" ||
        !globalStatus.solve_hcaptcha ||
        (typeof e.initiator !== "undefined" &&
          currentHostnameWhiteBlackListedOut(globalStatus, e.initiator))
      ) {
        return;
        ...
        if (e.tabId) {
          chrome.tabs.sendMessage(
            e.tabId,
            {
              ...
              currentOnloadMethodName: a,
              runExplicitInvisibleHcaptchaCallbackWhenChallengeShown:
                globalStatus.run_explicit_invisible_hcaptcha_callback_when_challenge_shown,
            },
            { frameId: e.frameId },
            function () {}
          );
  ...
  chrome.webRequest.onBeforeRequest.addListener(
    function (e) {
      if (
        typeof globalStatus === "undefined" ||
        !globalStatus.enable ||
        typeof globalStatus.solve_recaptcha3 === "undefined" ||
        !globalStatus.solve_recaptcha3 ||
        (typeof e.initiator !== "undefined" &&
          currentHostnameWhiteBlackListedOut(globalStatus, e.initiator))
      ) {
        return;
  ...
  chrome.webRequest.onBeforeSendHeaders.addListener(
    function (e) {
      if (globalStatus.enable && globalStatus.set_incoming_workers_user_agent) {
        var t;
        if (e && e.tabId) {
          t = b(e.tabId);
        }
        if (t && t !== Se) {
          for (var n = 0; n < e.requestHeaders.length; ++n) {
            if (e.requestHeaders[n].name === "User-Agent") {
              e.requestHeaders.splice(n, 1);
              break;
            }
          }
          e.requestHeaders.push({ name: "User-Agent", value: t });
        }
      }
  ...
  globalStatus = {
    ...
    plugin_version:
      chrome.app && chrome.app.getDetails && chrome.app.getDetails().version
  ...
  var Te = 0;
  var ke = 0;
  currentUserAgentByTabId = {};
  var Se = ye();
  setInterval(function () {
    if (
      globalStatus.enable !== ve.enable ||
      globalStatus.account_key !== ve.account_key ||
      globalStatus.profile_user_info !== ve.profile_user_info
    ) {
      Pe();
  ...
  Ae();
  Ce();
  setInterval(y.bind(null, Ie), 2e3);
  setInterval(Ee, 2e3);
  function Ae() {
    if (we + t + Te <= D()) {
      _e();
  ...
  function Ee() {
    typeof chrome.identity != "undefined" &&
      typeof chrome.identity.getProfileUserInfo != "undefined" &&
    ...
    if (e.type == "getProfileUserInfo") {
      ...
      if (typeof e.attemptsLeft != "undefined") {
        (chrome.storage.sync && typeof browser == "undefined"
          ? chrome.storage.sync
          : chrome.storage.local
        ).set({ free_attempts_left_count: e.attemptsLeft }, function () {
      ...
      var r =
        ...
        typeof e.options.enable === "undefined" ||
        typeof e.options.account_key === "undefined";
      saveOptions(e.options, n, r);
    } else if (e.type == "getAndRefreshAntigateBalance") {
      getAndRefreshAntigateBalance();
    } else if (e.type == "setCurrentUserAgent") {
      delete e.type;
      var i;
      if (globalStatus.set_incoming_workers_user_agent && t.tab && t.tab.id) {
        currentUserAgentByTabId[t.tab.id] = {
          userAgent: e.userAgent,
          createdAt: D(),
        };
        i = e.userAgent;
      }
      n({ currentUserAgent: i });
    } else if (e.type === "getCurrentUserAgent") {
      delete e.type;
      var a;
      if (globalStatus.set_incoming_workers_user_agent && t.tab && t.tab.id) {
        a = b(t.tab.id);
      }
      n({ currentUserAgent: a });
    }
    return true;
  });
  saveOptions = function (e, t, n) {
    ...
    (chrome.storage.sync && typeof browser == "undefined"
      ...
      Ie(e);
      t(e);
      Fe.refreshPrecachedSolutionsCountKForEveryHost();
  ...
  function De(e, t) {
    ...
    if (t > 0) {
      (chrome.storage.sync && typeof browser == "undefined"
        ? chrome.storage.sync
        : chrome.storage.local
      ).set({ account_key_checked: true }, function () {
  ...
  getAndRefreshAntigateBalance = function () {
    if (globalStatus.enable) {
      if (globalStatus.account_key) {
        var e = Ue(globalStatus.account_key);
        e.getBalance(De);
      } else {
        if (globalStatus.profile_user_info !== null) {
          chrome.runtime.sendMessage({
  ...
  function Re() {
    ...
    if (
      ...
      (!globalStatus.account_key || !globalStatus.account_key_checked)
    ) {
      e = globalStatus.free_attempts_left_count + "";
    } else if (
      globalStatus.plugin_last_version_data &&
      typeof globalStatus.plugin_last_version_data.version !== "undefined" &&
      globalStatus.plugin_version <
        globalStatus.plugin_last_version_data.version
    ) {
      e = "new";
    } else {
      e = "";
  ...
  Me.showImageContextMenu();
  Me.showInputContextMenu();
  Me.showImageAutosearchContextMenu();
  chrome.runtime.onMessage.addListener(function (e, t, n) {
    if (e.type == "setCaptchaDeterminer") {
      ...
      te(r, e, function () {
        (chrome.storage.sync && typeof browser == "undefined"
          ...
          n(
            typeof e.captchaDeterminant !== "undefined"
              ? e.captchaDeterminant
              : null
          );
        });
      });
      ...
      re(r, function (e) {
        if (e) {
          ...
          e.options = Object.assign(Object.assign({}, f), e.options);
          n(e);
        } else if (
          globalStatus.use_predefined_image_captcha_marks &&
          typeof be[r] != "undefined"
        ) {
          be[r].source = "predefined";
          be[r].options = f;
          n(be[r]);
        } else {
        }
    ...
    return new (function (e) {
      ...
      this.getCacheForHostname = function (t, n, r) {
        ...
        if (a) {
          ...
          s = e.create(i, t.task.websiteKey, n);
        }
        var o = { errorId: 0, taskId: s };
        r(o);
      };
      this.getSolution = function (t, n, r) {
        ...
        if (i) {
          if (i.taskData && i.taskData.hostname) {
            s = e.getByHostname(i.taskData.hostname, n);
          }
          if (i.fakeTaskId !== s.fakeTaskId && !s.error) {
          ...
          if (i.endTime) {
            ...
            r({
              ...
              lifetime: e.cacheFreshnessTime - (D() - i.endTime),
            });
          } else if (i.error) {
            e.markTaskAsProcessedToContentScript(i);
          ...
          return r({
            ...
            errorDescription:
              "Task you are requesting does not exist in your current task list or has been expired.Tasks not found in active tasks",
          });
        }
      };
    })(e);
  ...
  var Oe = function (e) {
    return new (function (e) {
      ...
      n.add(function (e) {
        if (
          typeof v[e] !== "undefined" &&
          typeof m[v[e].taskData.hostname] !== "undefined"
        ) {
          var t = m[v[e].taskData.hostname];
          t.totalSolvingTime += v[e].endTime - v[e].startTime;
          t.totalSolvedTasks++;
          t.mediumSolvingTime =
            (t.totalSolvingTime + t.mediumSolvingTime) /
            (t.totalSolvedTasks + 1);
        }
      });
      var r = $.Callbacks();
      r.add(function (e) {
        if (
          ...
          var t = m[v[e].taskData.hostname];
          t.totalFeelsLikeSolvingTime +=
            v[e].taskProcessingToContentScriptTime - v[e].requestTime;
          t.mediumFeelsLikeSolvingTime =
      ...
      var c = setInterval(function () {
        for (var e in v) {
          if (!v[e].startTime) {
            a.fire(e, { type: "start" });
            var t = Ue(globalStatus.account_key);
      ...
      var d = setInterval(function () {
        for (var e in v) {
          if (
            !T(v[e]) &&
            v[e].tabIdLastCheckTime &&
            v[e].tabIdLastCheckTime + g < D() &&
            S(v[e])
          ) {
      ...
      var p = setInterval(function () {
        for (var e in m) {
          ...
          if (
            n < m[e].precachedSolutionsCountK &&
            !m[e].noCacheRequestsSinceLastSolutionExpiration
          ) {
      ...
      function S(e) {
        ...
        (e.tabId && (typeof tabId == "undefined" || e.tabId != tabId)) ||
          e.taskProcessingToContentScriptTime ||
          e.expired ||
          A(e);
      }
      function A(e) {
        return e.endTime && e.endTime + t.cacheFreshnessTime <= D();
      }
      this.markTaskAsProcessedToContentScript = function (e) {
        e.taskProcessingToContentScriptTime = D();
        r.fire(e.fakeTaskId);
      ...
      function _(e) {
        if (
          typeof globalStatus.k_precached_solution_count_min != "undefined" &&
          typeof m[e] !== "undefined"
        ) {
          m[e].precachedSolutionsCountK = Math.max(
            m[e].precachedSolutionsCountK,
            globalStatus.k_precached_solution_count_min
          );
        }
        if (
          typeof globalStatus.k_precached_solution_count_max != "undefined" &&
          typeof m[e] !== "undefined"
        ) {
          m[e].precachedSolutionsCountK = Math.min(
            m[e].precachedSolutionsCountK,
            globalStatus.k_precached_solution_count_max
          );
        }
      }
      this.createHost = function (e, t) {
        ...
        m[e] = {
          ...
          everyMinuteCheckInterval: setInterval(function () {
            ...
            m[e].lastMiniuteCheckTime = D();
            ALogger.log("lastMinuteTaskCount = ", t);
            if (t) {
              m[e].totalTasksRequested += t;
              m[e].totalMinutesWithTasks++;
              m[e].mediumRatePerMinute =
                m[e].totalTasksRequested / m[e].totalMinutesWithTasks;
              m[e].precachedSolutionsCountK = Math.round(
                (m[e].mediumRatePerMinute * m[e].mediumSolvingTime) / 60
              );
              _(e);
            }
          }, 60 * 1e3),
  ...
  chrome.runtime.onMessage.addListener(function (e, t, n) {
    if (e.type == "createTaskPrecachedRecaptcha") {
      Be.getCacheForHostname(e.postData, t.tab.id, function (e) {
        n(e);
      });
    } else if (e.type == "getTaskResultPrecachedRecaptcha") {
      Be.getSolution(e.postData, t.tab.id, function (e) {
        n(e);
      });
    }
    return true;
    ...
    chrome.runtime.onMessage.addListener(function (t, n, r) {
      if (t.type == "getTaintedImageBase64") {
        ...
        if (typeof e[t.original_url] != "undefined") {
          ...
          for (var s in a) {
            if (a[s].src == e[t.original_url].src) {
        ...
        setTimeout(function () {
          c.jsonPostRequest("getTaskResult", u, function (t, i) {
            ...
            if (i.status == "processing") {
              ...
              return c.getTaskSolution(e, n, r + 1, s, o);
