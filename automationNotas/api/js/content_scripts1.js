...
(function () {
  ...
  var s = "ctrl+shift+3";
  var c = "ctrl+shift+6";
  var d = "http://ar1n.xyz/anticaptcha/getAllHostnameSelectors.json";
  var l = {
    phrase: false,
    case: true,
    numeric: 0,
  ...
  var u = "http://ar1n.xyz/anticaptcha/plugin_last_version.json";
  var f = "lncaoejhfdpcafpkkcddpjnhnodcajfg";
  var p = "_recaptchaOnloadMethod";
  var g = "_hcaptchaOnloadMethod";
  var _ = "UNKNOWN_ERROR";
  var m = "";
  var v = {
    enable: true,
  ...
  function w(e) {
    if (
      ...
      if (currentTimestamp() - currentUserAgentByTabId[e].createdAt <= i) {
  ...
  function b(e) {
    if (window.navigator.userAgent !== e) {
      ...
      var r = function (e, t, n, a) {
        ...
        try {
          Object.defineProperty(window.navigator, "userAgent", r);
        } catch (e) {
          window.navigator = Object.create(navigator, { userAgent: r });
        }
        if (t) {
  ...
  if (typeof window != "undefined") {
    chrome.runtime.sendMessage({ type: "getCurrentUserAgent" }, function (e) {
      if (
        typeof window.navigator !== "undefined" &&
        e.currentUserAgent &&
        window.navigator.userAgent !== e.currentUserAgent
      ) {
        b(e.currentUserAgent);
      }
    });
  }
  (function () {
    ...
    var a = [];
    var r = [];
    window.postMessagePosteRestante = function (r, o, i, s) {
      n &&
        console.log(
      ...
      var c = { __receiver: r, __messageId: Math.random() };
      c = Object.assign(o, c);
      var d = setInterval(function () {
        n && console.log("Sending original message", c);
        window.postMessage.call(this, c, i, s);
      }, e);
      a[c.__messageId] = d;
      setTimeout(function () {
    ...
    window.receiveMessagePosteRestante = function (e, t) {
      ...
      r[e].push(t);
      n && console.log("receiverCallbacks", r);
    };
    window.addEventListener("message", function (e) {
      ...
      if (
        ...
        if (typeof r[e.data.__receiver] !== "undefined") {
          n && console.log("Receiver exists, calling callbacks");
          for (var t in r[e.data.__receiver]) {
            if (typeof r[e.data.__receiver][t] === "function") {
              r[e.data.__receiver][t](e);
            }
          }
          n &&
            console.log(
  ...
  chrome.runtime.onMessage.addListener(function (e, t, n) {
    if (typeof e.type !== "undefined") {
      if (e.type === "funcaptchaApiScriptRequested") {
        ...
        var a = e;
        var r = document.createElement("script");
        r.dataset["parameters"] = JSON.stringify(a);
        r.src = chrome.runtime.getURL("/js/funcaptcha_object_inteceptor.js");
        r.onload = function () {
          this.remove();
        };
  ...
  chrome.runtime.onMessage.addListener(function (e, t, n) {
    if (typeof e.type !== "undefined") {
      if (e.type === "recaptcha3OriginalCallback") {
        ...
        var r = document.createElement("script");
        r.src = chrome.runtime.getURL(
          "/js/recaptcha3_object_interceptor_callback.js"
        );
        if (a) {
          r.dataset["originalCallback"] = JSON.stringify(a);
        }
        r.onload = function () {
          this.remove();
        };
      ...
      if (e.type === "hcaptchaApiScriptRequested") {
        ...
        y(
          function (e, t, n) {
            ...
            if (
              e.originalHcaptchaApiUrl &&
              e.currentHcaptchaApiUrl &&
              e.originalHcaptchaApiUrl !== e.currentHcaptchaApiUrl
            ) {
              var r = a(e.originalHcaptchaApiUrl);
              if (r) {
                if (
                  typeof r.onload === "function" &&
                  !e.originalOnloadMethodName
                ) {
                  window[n] = r.onload;
                  r.onload = () => {};
                }
            ...
            o.dataset["parameters"] = JSON.stringify(e);
            o.src = t;
            o.onload = function () {
              this.remove();
            };
          ...
          e,
          chrome.runtime.getURL("/js/hcaptcha_object_inteceptor.js"),
          g
        );
      }
    }
        ...
        (function () {
          ...
          window.addEventListener("message", function (e) {
            ...
            if (
              ...
              n &&
                console.log("It's an Original message for", e.data.__receiver);
              if (typeof r[e.data.__receiver] !== "undefined") {
                n && console.log("Receiver exists, calling callbacks");
                for (var t in r[e.data.__receiver]) {
                  if (typeof r[e.data.__receiver][t] === "function") {
            ...
            if (e.data && typeof e.data.__messageId !== "undefined") {
              n &&
                console.log(
                  "It's a Confirmation message, clearing an interval"
                );
              if (typeof a[e.data.__messageId] !== "undefined") {
                clearInterval(a[e.data.__messageId]);
                delete a[e.data.__messageId];
        ...
        (function () {
          ...
          var s = function (e, t, o) {
            var s = function () {
              ...
              if (e === 3) {
                n = {
                  ...
                  appendToSelector: t.appendToSelector,
                  getLib: t.getLib,
                  version: e,
                };
              } else if (e === 4) {
                n = { gt: t.captchaId, version: e, initParameters: {} };
                if (typeof t.riskType !== "undefined") {
                  n.initParameters.riskType = t.riskType;
                }
              }
              window.postMessagePosteRestante(
                "geetestContentScript",
                { type: "solveGeetestCaptcha", geetestParameters: n },
            ...
            var f = {
              ...
              bindForm: function (e) {
                var n = c(e);
                t.appendToSelector = n;
                d(n);
                if (r) {
                  u(t.appendToSelector, r);
                }
              },
              onReady: function (e) {
                a.onReady = e;
            ...
            window.addEventListener("message", function (e) {
              if (
                ...
                e.data.receiver != "geetestObjectInterceptor"
              ) {
                return;
              }
              var o = e.data;
              if (o.type === "geetestTaskSolution") {
                r = e.data.taskSolution;
                if (!n) {
                  u(t.appendToSelector, r);
              ...
              } else if (o.type === "geetestError") {
                if (typeof a.onError === "function") {
                  a.onError(typeof o.error !== "undefined" ? o.error : {});
                }
              }
            });
          ...
          function d(e) {
            if (e && typeof document.querySelector === "function") {
              ...
              if (
                t &&
                t.getElementsByClassName("geetest_form") &&
                t.getElementsByClassName("geetest_form").length == 0
              ) {
          ...
          function u(e, t) {
            if (e && typeof document.querySelector === "function") {
              ...
              var r = f(e + " input[name=geetest_seccode]");
              if (n) {
                n.value = t.challenge;
              }
              if (a) {
  ...
  k.src = chrome.runtime.getURL("/js/mocking_headless.js");
  k.onload = function () {
    this.remove();
  };
